...
data_out='kgo_m2fs.dat'
fits_table_filename='kgo_m2fs.fits'

with open('kgo_m2fs_files0') as f:
...
#                np.pause()
    if compile_fits:#process posterior files and put results into new fits file
        ...
        if len(fitsobject.obj)>0:
            ...
            col7=fits.Column(name='posterior_moments',format='64D',dim='(16,4)',array=multinest.moments)
            col8=fits.Column(name='posterior_1000',format='16000D',dim='(16,1000)',array=multinest.posterior_1000)
...
col24=fits.Column(name='resolution_sigma',format='D',array=resolution_sigma[targets])
col25=fits.Column(name='resolution_sigma_error',format='D',array=resolution_sigma_sig[targets])
col26=fits.Column(name='resolution_sigma_skew',format='D',array=resolution_sigma_skew[targets])
col27=fits.Column(name='resolution_sigma_kurtosis',format='D',array=resolution_sigma_kurt[targets])
col28=fits.Column(name='median_sky',format='D',array=postfit_mediansky[targets])
col29=fits.Column(name='standard_deviation_median_sky',format='D',array=postfit_stdsky[targets])
col30=fits.Column(name='filtername',format='A100',array=postfit_filtername[targets])
col31=fits.Column(name='chi2',format='D',array=postfit_chi2[targets])
col32=fits.Column(name='chi2_modified',format='D',array=postfit_chi22[targets])
col33=fits.Column(name='n',format='D',array=postfit_n[targets])
col34=fits.Column(name='run_id',format='A100',array=postfit_run_id[targets])
col35=fits.Column(name='field_name',format='A100',array=postfit_field_name[targets])
col36=fits.Column(name='wav_npoints',format='PI()',array=postfit_wav_npoints[targets])
col37=fits.Column(name='wav_rms',format='PD()',array=postfit_wav_rms[targets])
col38=fits.Column(name='wav_resolution',format='PD()',array=postfit_wav_resolution[targets])
col39=fits.Column(name='wav_min',format='PD()',array=postfit_wav_min[targets])
col40=fits.Column(name='wav_max',format='PD()',array=postfit_wav_max[targets])
col41=fits.Column(name='row',format='D',array=postfit_row[targets])
col42=fits.Column(name='temperature',format='PD()',array=postfit_temperature[targets])
col43=fits.Column(name='vhelio_correction',format='D',array=postfit_vhelio_correction[targets])

cols=fits.ColDefs([col1,col2,col3,col4,col5,col6,col7,col8,col9,col10,col11,col12,col13,col14,col15,col16,col17,col18,col19,col20,col21,col22,col23,col24,col25,col26,col27,col28,col29,col30,col31,col32,col33,col34,col35,col36,col37,col38,col39,col40,col41,col42,col43])
...
tab=Table()
tab['ra_deg']=t.data['ra_deg']
tab['dec_deg']=t.data['dec_deg']
tab['mjd']=t.data['mjd']
tab['hjd']=t.data['hjd']
tab['sn_ratio']=t.data['sn_ratio']
tab['vlos']=t.data['vlos']
tab['vlos_error']=t.data['vlos_error']
tab['vlos_skew']=t.data['vlos_skew']
tab['vlos_kurtosis']=t.data['vlos_kurtosis']
tab['teff']=t.data['teff']
tab['teff_error']=t.data['teff_error']
tab['teff_skew']=t.data['teff_skew']
tab['teff_kurtosis']=t.data['teff_kurtosis']
tab['logg']=t.data['logg']
tab['logg_error']=t.data['logg_error']
tab['logg_skew']=t.data['logg_skew']
tab['logg_kurtosis']=t.data['logg_kurtosis']
tab['z']=t.data['z']
tab['z_error']=t.data['z_error']
tab['z_skew']=t.data['z_skew']
tab['z_kurtosis']=t.data['z_kurtosis']
tab['resolution_sigma']=t.data['resolution_sigma']
tab['resolution_sigma_error']=t.data['resolution_sigma_error']
tab['resolution_sigma_skew']=t.data['resolution_sigma_skew']
tab['resolution_sigma_kurtosis']=t.data['resolution_sigma_kurtosis']
tab['median_sky']=t.data['median_sky']
tab['standard_deviation_median_sky']=t.data['standard_deviation_median_sky']
tab['filtername']=t.data['filtername']
tab['chi2']=t.data['chi2']
tab['chi2_modified']=t.data['chi2_modified']
tab['n']=t.data['n']
tab['run_id']=t.data['run_id']
tab['field_name']=t.data['field_name']
tab['wav_npoints']=t.data['wav_npoints']
tab['wav_rms']=t.data['wav_rms']
tab['wav_resolution']=t.data['wav_resolution']
tab['wav_min']=t.data['wav_min']
tab['wav_max']=t.data['wav_max']
tab['row']=t.data['row']
tab['temperature']=t.data['temperature']
tab['vhelio_correction']=t.data['vhelio_correction']
shite=ascii.write(tab,'kgo_m2fs.ecsv',overwrite=True,format='ecsv',formats={'ra_deg':'12.6f','dec_deg':'12.6f','hjd':'f10.2','sn_ratio':'f7.2','vlos':'f10.2','vlos_error':'f10.2','vlos_skew':'f10.2','vlos_kurtosis':'f10.2','teff':'i6','teff_error':'i6','teff_skew':'f10.2','teff_kurtosis':'f10.2','logg':'f5.2','logg_error':'f5.2','logg_skew':'f10.2','logg_kurtosis':'f10.2','z':'f6.2','z_error':'f6.2','z_skew':'f10.2','z_kurtosis':'f10.2','resolution_sigma':'f6.3','resolution_sigma_error':'f6.3','resolution_sigma_skew':'f10.2','resolution_sigma_kurtosis':'f10.2','median_sky':'f10.2','standard_deviation_median_sky':'f10.2','filtername':'a10','chi2':'f10.2','chi2_modified':'f10.2','n':'i5'})
...
ax1.set_xscale('log')
ax1.set_yscale('log')
ax1.scatter((10.**phantom1),(10.**phantom2),s=1,color='k',alpha=0.3)
ax1.scatter((10.**phantom1[keep]),(10.**phantom2[keep]),s=1,color='r',alpha=0.3)
ax1.set_xscale('log')
ax1.set_yscale('log')
...
plt.savefig('scl_m2fs.pdf',dpi=200)
...
plt.yscale('log')
plt.ylim([0.1,10])
plt.scatter(postfit_snratio[keep2],postfit_chi2[keep2]/postfit_n[keep2],s=1,alpha=0.2,color='k')
plt.scatter(postfit_snratio[keep],postfit_chi2[keep]/postfit_n[keep],s=1,alpha=0.2,color='r')
plt.scatter(postfit_snratio[keep2],postfit_chi22[keep2]/postfit_n[keep2],s=1,alpha=0.2,color='b')
plt.scatter(postfit_snratio[keep],postfit_chi22[keep]/postfit_n[keep],s=1,alpha=0.2,color='g')
plt.xscale('log')
plt.yscale('log')
plt.xlim([0.1,100])
plt.ylim([0.1,100])
...
#plt.savefig(fname='m2fs_chi2.pdf',dpi=200)
plt.show()
plt.close()
