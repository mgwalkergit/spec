...
data7='cra_gradientpost_equal_weights.dat'
...
cra_rhalf0=20.
cra_sigrhalf0=5.
cra_rhalf=np.random.normal(loc=cra_rhalf0,scale=cra_sigrhalf0,size=len(cravdisp))
#cra_sigrhalf=np.array([1.])
cra_absvmag0=-5.3
cra_sigabsvmag0=0.2
cra_absvmag=np.random.normal(loc=cra_absvmag0,scale=cra_sigabsvmag0,size=len(cravdisp))
...
ax0_0=fig.add_subplot(gs[0:3,0:5])
ax1_0=fig.add_subplot(gs[3:6,0:5])
ax2_0=fig.add_subplot(gs[6:9,0:5])
...
ax0_0.scatter(np.median(cra_absvmag),np.median(cra_rhalf),s=10,lw=0,edgecolor='none',alpha=0.99,marker='v',color='k',rasterized=True)
...
ax0_0.errorbar(np.median(cra_absvmag),np.median(cra_rhalf),xerr=np.std(cra_absvmag),yerr=cra_sigrhalf0,elinewidth=0.5,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
ax1_0.scatter(np.median(cra_absvmag),cra_feh,s=10,lw=0,edgecolor='none',alpha=0.99,marker='v',color='k',rasterized=True)
ax1_0.scatter(np.median(gru1_absvmag),gru1_feh,s=20,lw=0,edgecolor='none',alpha=0.99,marker='^',color='k',rasterized=True)
...
ax1_0.errorbar(np.median(cra_absvmag),cra_feh,xerr=np.std(cra_absvmag),yerr=cra_sigfeh,elinewidth=0.5,fmt='o',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax1_0.text(np.median(cra_absvmag)-0.2,cra_feh[0]-0.2,'Cra',fontsize=7,color='k')
...
ax2_0.scatter(np.median(cra_absvmag0),np.median(cra_mlratio0),s=10,lw=0,edgecolor='none',alpha=0.99,marker='v',color='k',rasterized=True,label='Cra')
#ax2_0.text(np.median(tuc2_absvmag)-0.2,tuc2_mlratio0[0]-0.2,'Tuc 2',fontsize=7,color='k')
#ax2_0.text(np.median(cra_absvmag)-0.2,cra_mlratio0[0]-0.2,'Cra',fontsize=7,color='k')
ax2_0.scatter(np.median(gru1_absvmag0),np.median(gru1_mlratio0),s=20,lw=0,edgecolor='none',alpha=0.99,marker='^',color='k',rasterized=True,label='Gru 1')
...
ax2_0.errorbar(np.median(cra_absvmag),np.median(cra_mlratio),xerr=np.std(cra_absvmag),yerr=[cra_lower_error,cra_upper_error],elinewidth=0.5,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
plotfilename='apr16_scaling.pdf'
