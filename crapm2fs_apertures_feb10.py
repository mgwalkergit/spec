...
for i in range(0,len(utdate)):
    for ccd in ('r','b'):
        ...
        stack_array_file=root2+'_stack_array2.pickle'
        stack_fits_file=root2+'stackskysub2.fits'
...
#                id_lines_array_file=datadir+utdate[i]+'/'+ccd+str(tharfile0[i][0]).zfill(4)+'_id_lines_array.pickle'
                    plugmap_file=root0+'_plugmap.pickle'
                    wavcal_array_file=root0+'_wavcal_array.pickle'
                    sky_array_file=root0+'_sky_array2.pickle'
                    skysubtract_array_file=root0+'_skysubtract_array2.pickle'
                    ...
                    if (not(skysubtract_array_exists))|(skysubtract_array_exists & overwrite):
                        ...
                        meansky=m2fs.get_meansky(extract1d_array,wavcal_array,plugmap0)#thar,id_lines_minlines,thar_mjd,mjd,plugmap0)
