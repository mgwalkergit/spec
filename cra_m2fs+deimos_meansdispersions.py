...
data3='crak15_gradientpost_equal_weights.dat'
...
for line in data: # fill arrays
    p=line.split()
    vmean3.append(float(p[0]))
    vdisp3.append(float(p[1]))
    vgrad3.append(float(p[2]))
    vtheta3.append(float(p[3]))
    fehmean3.append(float(p[4]))
    fehdisp3.append(float(p[5]))
    fehgrad3.append(float(p[6]))
    like3.append(float(p[7]))

vmean3=np.array(vmean3)
vdisp3=np.array(vdisp3)
vgrad3=np.array(vgrad3)
vtheta3=np.array(vtheta3)
fehmean3=np.array(fehmean3)
fehdisp3=np.array(fehdisp3)
fehgrad3=np.array(fehgrad3)
...
vmeanticks=[143,146,149,152,155]
vdispticks=[0,1,2,3,4,5]
vgradticks=[1,2,3,4]
vthetaticks=[-150,0,150]
fehmeanticks=[-3,-2,-1,0]
...
ax0_0.set_ylabel('probability',fontsize=8,rotation=90,labelpad=10)
...
ax0_0.hist(vmean3,bins=50,range=vmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.5)
...
ax1_1.hist(vdisp2,bins=50,range=vdisplim,normed=True,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.5)
ax1_1.hist(vdisp3,bins=50,range=vdisplim,normed=True,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='b',linewidth=0.5)
...
ax11_0.set_ylabel('probability',fontsize=8,rotation=90,labelpad=10)
...
ax11_0.hist(fehmean,bins=50,range=fehmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5,label='M2FS')
ax11_0.hist(fehmean3,bins=50,range=fehmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.5,label='Deimos')
ax11_0.hist(fehmean2,bins=50,range=fehmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5,label='combined')
ax11_0.legend(loc=2,fontsize=4.5,handlelength=0,shadow=False,borderpad=0.75)
...
ax11_1.hist(fehdisp2,bins=50,range=fehdisplim,normed=True,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.5)
ax11_1.hist(fehdisp3,bins=50,range=fehdisplim,normed=True,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='b',linewidth=0.5)


plotfilename='cra_m2fs+deimos_meansdispersions.pdf'
