...
#tuc2_keep=np.where((tuc2_sigv < minsigv) & (tuc2_skewv >= -1.) & (tuc2_skewv <= 1.) & (tuc2_kurtv >= -1) & (tuc2_kurtv <= 1))
tuc2_keep=np.where((tuc2_sigv < minsigv))#) & (tuc2_skewv >= -1.) & (tuc2_skewv <= 1.) & (tuc2_kurtv >= -1) & (tuc2_kurtv <= 1))
#tuc2_mem=np.where((tuc2_sigv < minsigv) & (tuc2_skewv > -1.) & (tuc2_skewv < 1.) & (tuc2_kurtv > -1.) & (tuc2_kurtv < 1.) & (tuc2_pmem > 0.9))
tuc2_mem=np.where((tuc2_sigv < minsigv) & (tuc2_pmem > 0.5))
tuc2_goodmem=np.where((tuc2_sigv < minsigv) & (tuc2_pmem > 0.9))
tuc2_nonmem=np.where((tuc2_sigv < minsigv) & (tuc2_pmem < 0.5))
tuc2_goodnonmem=np.where((tuc2_sigv < minsigv) & (tuc2_pmem < 0.5))
tuc2_bad=np.where(tuc2_sigv >= minsigv)

tuc2_vmem=[-150.,-110.]
tuc2_loggmem=[0.0,4.0]
tuc2_fehmem=[-5.,0.]
...
#gru1_keep=np.where((gru1_sigv < minsigv) & (gru1_skewv >= -1.) & (gru1_skewv <= 1.) & (gru1_kurtv >= -1) & (gru1_kurtv <= 1))
gru1_keep=np.where((gru1_sigv < minsigv))# & (gru1_skewv >= -1.) & (gru1_skewv <= 1.) & (gru1_kurtv >= -1) & (gru1_kurtv <= 1))
#gru1_mem=np.where((gru1_sigv < minsigv) & (gru1_skewv > -1.) & (gru1_skewv < 1.) & (gru1_kurtv > -1.) & (gru1_kurtv < 1.) & (gru1_pmem > 0.9))
gru1_mem=np.where((gru1_sigv < minsigv) & (gru1_pmem > 0.5))
gru1_goodmem=np.where((gru1_sigv < minsigv) & (gru1_pmem > 0.9))
gru1_nonmem=np.where((gru1_sigv < minsigv) & (gru1_pmem < 0.5))
gru1_goodnonmem=np.where((gru1_sigv < minsigv) & (gru1_pmem < 0.5))
gru1_bad=np.where(gru1_sigv >= minsigv)

gru1_vmem=[-165.,-120.]
gru1_loggmem=[0.0,4.0]
gru1_fehmem=[-5.,0.]
...
ax0_0.hist(tuc2_v[tuc2_keep],bins=30,range=vlim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25,label='Tuc 2')
ax0_0.hist(tuc2_v[tuc2_mem],bins=30,range=vlim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25,alpha=0.5)
ax0_0.hist(gru1_v[gru1_keep],bins=30,range=vlim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25,label='Gru 1')
ax0_0.hist(gru1_v[gru1_mem],bins=30,range=vlim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25,alpha=0.5)
ax0_0.legend(loc=2,fontsize=6,handlelength=0.5,numpoints=1,scatterpoints=1,shadow=False,borderpad=0)
...
ax0_1.set_xlim(revtefflim)
ax0_1.set_ylim(histlim)
ax0_1.set_xticks(revteffticks)
ax0_1.set_yticks(histticks)
ax0_1.hist(tuc2_teff[tuc2_keep],bins=30,range=tefflim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25)
ax0_1.hist(tuc2_teff[tuc2_mem],bins=30,range=tefflim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25,alpha=0.5)
ax0_1.hist(gru1_teff[gru1_keep],bins=30,range=tefflim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25)
ax0_1.hist(gru1_teff[gru1_mem],bins=30,range=tefflim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25,alpha=0.5)
...
ax0_2.set_xlim(revlogglim)
ax0_2.set_ylim(histlim)
ax0_2.set_xticks(revloggticks)
ax0_2.set_yticks(histticks)
ax0_2.hist(tuc2_logg[tuc2_keep],bins=30,range=logglim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25)
ax0_2.hist(tuc2_logg[tuc2_mem],bins=30,range=logglim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25,alpha=0.5)
ax0_2.hist(gru1_logg[gru1_keep],bins=30,range=logglim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25)
ax0_2.hist(gru1_logg[gru1_mem],bins=30,range=logglim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25,alpha=0.5)
...
ax0_3.hist(tuc2_feh[tuc2_keep],bins=30,range=fehlim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25)
ax0_3.hist(tuc2_feh[tuc2_mem],bins=30,range=fehlim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.25,alpha=0.5)
ax0_3.hist(gru1_feh[gru1_keep],bins=30,range=fehlim,normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25)
ax0_3.hist(gru1_feh[gru1_mem],bins=30,range=fehlim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.25,alpha=0.5)


ax1_4.set_xlabel('N',fontsize=8,rotation=0,labelpad=5)
ax1_4.yaxis.set_major_formatter(plt.NullFormatter())
ax1_4.set_ylim(revmaglim)
ax1_4.set_xlim(histlim)
ax1_4.xaxis.tick_top()
ax1_4.set_yticks(revmagticks)
ax1_4.set_xticks(histticks)
ax1_4.xaxis.set_label_position('top')
ax1_4.hist(tuc2_mag[tuc2_keep],bins=30,range=maglim,normed=False,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.25)
ax1_4.hist(tuc2_mag[tuc2_mem],bins=30,range=maglim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.25,alpha=0.5)
ax1_4.hist(gru1_mag[gru1_keep],bins=30,range=maglim,normed=False,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='b',linewidth=0.25)
ax1_4.hist(gru1_mag[gru1_mem],bins=30,range=maglim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='horizontal',color='b',linewidth=0.25,alpha=0.5)
...
ax2_4.hist(tuc2_col[tuc2_keep],bins=30,range=collim,normed=False,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.25)
ax2_4.hist(tuc2_col[tuc2_mem],bins=30,range=collim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.25,alpha=0.5)
ax2_4.hist(gru1_col[gru1_keep],bins=30,range=collim,normed=False,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='b',linewidth=0.25)
ax2_4.hist(gru1_col[gru1_mem],bins=30,range=collim,normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='horizontal',color='b',linewidth=0.25,alpha=0.5)
...
ax2_0.add_patch(Rectangle((gru1_vmem[0],gru1_colmem[0]),gru1_vmem[1]-gru1_vmem[0],gru1_colmem[1]-gru1_colmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax2_0.add_patch(Rectangle((tuc2_vmem[0],tuc2_colmem[0]),tuc2_vmem[1]-tuc2_vmem[0],tuc2_colmem[1]-tuc2_colmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax2_0.errorbar(tuc2_v[tuc2_keep],tuc2_col[tuc2_keep],xerr=tuc2_sigv[tuc2_keep],yerr=tuc2_sigcol[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax2_0.errorbar(gru1_v[gru1_keep],gru1_col[gru1_keep],xerr=gru1_sigv[gru1_keep],yerr=gru1_sigcol[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)

ax1_0.set_ylabel(maglabel[0],fontsize=8,rotation=90,labelpad=5)
ax1_0.set_xlim(vlim)
ax1_0.set_ylim(revmaglim)
ax1_0.set_xscale(u'linear')
ax1_0.set_yscale(u'linear')
ax1_0.set_xticks(vticks)
ax1_0.set_xticklabels(vticks,rotation=0)
ax1_0.set_yticks(revmagticks)
ax1_0.xaxis.set_major_formatter(plt.NullFormatter())
ax1_0.add_patch(Rectangle((gru1_vmem[0],gru1_magmem[0]),gru1_vmem[1]-gru1_vmem[0],gru1_magmem[1]-gru1_magmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax1_0.add_patch(Rectangle((tuc2_vmem[0],tuc2_magmem[0]),tuc2_vmem[1]-tuc2_vmem[0],tuc2_magmem[1]-tuc2_magmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax1_0.errorbar(tuc2_v[tuc2_keep],tuc2_mag[tuc2_keep],xerr=tuc2_sigv[tuc2_keep],yerr=tuc2_sigmag[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax1_0.errorbar(gru1_v[gru1_keep],gru1_mag[gru1_keep],xerr=gru1_sigv[gru1_keep],yerr=gru1_sigmag[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)
...
ax2_1.set_xticklabels(revteffticks,rotation=0)
...
ax2_1.add_patch(Rectangle((gru1_teffmem[0],gru1_colmem[0]),gru1_teffmem[1]-gru1_teffmem[0],gru1_colmem[1]-gru1_colmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax2_1.add_patch(Rectangle((tuc2_teffmem[0],tuc2_colmem[0]),tuc2_teffmem[1]-tuc2_teffmem[0],tuc2_colmem[1]-tuc2_colmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax2_1.errorbar(tuc2_teff[tuc2_keep],tuc2_col[tuc2_keep],xerr=tuc2_sigteff[tuc2_keep],yerr=tuc2_sigcol[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax2_1.errorbar(gru1_teff[gru1_keep],gru1_col[gru1_keep],xerr=gru1_sigteff[gru1_keep],yerr=gru1_sigcol[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)

ax1_1.set_xlim(revtefflim)
ax1_1.set_ylim(revmaglim)
ax1_1.set_xscale(u'linear')
ax1_1.set_yscale(u'linear')
ax1_1.set_xticks(revteffticks)
ax1_1.set_xticklabels(revteffticks,rotation=0)
ax1_1.set_yticks(revmagticks)
ax1_1.xaxis.set_major_formatter(plt.NullFormatter())
ax1_1.yaxis.set_major_formatter(plt.NullFormatter())
ax1_1.add_patch(Rectangle((gru1_teffmem[0],gru1_magmem[0]),gru1_teffmem[1]-gru1_teffmem[0],gru1_magmem[1]-gru1_magmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax1_1.add_patch(Rectangle((tuc2_teffmem[0],tuc2_magmem[0]),tuc2_teffmem[1]-tuc2_teffmem[0],tuc2_magmem[1]-tuc2_magmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax1_1.errorbar(tuc2_teff[tuc2_keep],tuc2_mag[tuc2_keep],xerr=tuc2_sigteff[tuc2_keep],yerr=tuc2_sigmag[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax1_1.errorbar(gru1_teff[gru1_keep],gru1_mag[gru1_keep],xerr=gru1_sigteff[gru1_keep],yerr=gru1_sigmag[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)
...
ax2_2.set_xticklabels(revloggticks,rotation=0)
...
ax2_2.add_patch(Rectangle((gru1_loggmem[0],gru1_colmem[0]),gru1_loggmem[1]-gru1_loggmem[0],gru1_colmem[1]-gru1_colmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax2_2.add_patch(Rectangle((tuc2_loggmem[0],tuc2_colmem[0]),tuc2_loggmem[1]-tuc2_loggmem[0],tuc2_colmem[1]-tuc2_colmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax2_2.errorbar(tuc2_logg[tuc2_keep],tuc2_col[tuc2_keep],xerr=tuc2_siglogg[tuc2_keep],yerr=tuc2_sigcol[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax2_2.errorbar(gru1_logg[gru1_keep],gru1_col[gru1_keep],xerr=gru1_siglogg[gru1_keep],yerr=gru1_sigcol[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)

ax1_2.set_xlim(revlogglim)
ax1_2.set_ylim(revmaglim)
ax1_2.set_xscale(u'linear')
ax1_2.set_yscale(u'linear')
ax1_2.set_xticks(revloggticks)
ax1_2.set_xticklabels(revloggticks,rotation=0)
ax1_2.set_yticks(revmagticks)
ax1_2.xaxis.set_major_formatter(plt.NullFormatter())
ax1_2.yaxis.set_major_formatter(plt.NullFormatter())
ax1_2.add_patch(Rectangle((gru1_loggmem[0],gru1_magmem[0]),gru1_loggmem[1]-gru1_loggmem[0],gru1_magmem[1]-gru1_magmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax1_2.add_patch(Rectangle((tuc2_loggmem[0],tuc2_magmem[0]),tuc2_loggmem[1]-tuc2_loggmem[0],tuc2_magmem[1]-tuc2_magmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax1_2.errorbar(tuc2_logg[tuc2_keep],tuc2_mag[tuc2_keep],xerr=tuc2_siglogg[tuc2_keep],yerr=tuc2_sigmag[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax1_2.errorbar(gru1_logg[gru1_keep],gru1_mag[gru1_keep],xerr=gru1_siglogg[gru1_keep],yerr=gru1_sigmag[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)
...
ax2_3.add_patch(Rectangle((gru1_fehmem[0],gru1_colmem[0]),gru1_fehmem[1]-gru1_fehmem[0],gru1_colmem[1]-gru1_colmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax2_3.add_patch(Rectangle((tuc2_fehmem[0],tuc2_colmem[0]),tuc2_fehmem[1]-tuc2_fehmem[0],tuc2_colmem[1]-tuc2_colmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax2_3.errorbar(tuc2_feh[tuc2_keep],tuc2_col[tuc2_keep],xerr=tuc2_sigfeh[tuc2_keep],yerr=tuc2_sigcol[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax2_3.errorbar(gru1_feh[gru1_keep],gru1_col[gru1_keep],xerr=gru1_sigfeh[gru1_keep],yerr=gru1_sigcol[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)

ax1_3.set_xlim(fehlim)
ax1_3.set_ylim(revmaglim)
ax1_3.set_xscale(u'linear')
ax1_3.set_yscale(u'linear')
ax1_3.set_xticks(fehticks)
ax1_3.set_xticklabels(fehticks,rotation=0)
ax1_3.set_yticks(revmagticks)
ax1_3.xaxis.set_major_formatter(plt.NullFormatter())
ax1_3.yaxis.set_major_formatter(plt.NullFormatter())
ax1_3.add_patch(Rectangle((gru1_fehmem[0],gru1_magmem[0]),gru1_fehmem[1]-gru1_fehmem[0],gru1_magmem[1]-gru1_magmem[0],facecolor='b',alpha=0.2,edgecolor='None'))
ax1_3.add_patch(Rectangle((tuc2_fehmem[0],tuc2_magmem[0]),tuc2_fehmem[1]-tuc2_fehmem[0],tuc2_magmem[1]-tuc2_magmem[0],facecolor='r',alpha=0.2,edgecolor='None'))
ax1_3.errorbar(tuc2_feh[tuc2_keep],tuc2_mag[tuc2_keep],xerr=tuc2_sigfeh[tuc2_keep],yerr=tuc2_sigmag[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='r',rasterized=True)
ax1_3.errorbar(gru1_feh[gru1_keep],gru1_mag[gru1_keep],xerr=gru1_sigfeh[gru1_keep],yerr=gru1_sigmag[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='b',rasterized=True)
...
ax10_10.errorbar(tuc2_teff[tuc2_keep],tuc2_logg[tuc2_keep],xerr=tuc2_sigteff[tuc2_keep],yerr=tuc2_siglogg[tuc2_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='k',rasterized=True,label='foreground')
...
ax10_10.errorbar(gru1_teff[gru1_keep],gru1_logg[gru1_keep],xerr=gru1_sigteff[gru1_keep],yerr=gru1_siglogg[gru1_keep],elinewidth=0.5,fmt='.',capsize=0,alpha=0.65,color='k',rasterized=True)
...
plotfilename='tuc2gru1_params.pdf'
