...
#                exptime_total+=np.float(j)
    ...
    field_object_formal[dsph]='Crater 1'
    ...
    field_object_formal[dsph]='Hydrus I'
    dsph=np.where(field_object=='ind1')[0]
    field_object_formal[dsph]='Indus 1'
    dsph=np.where(field_object=='ind2')[0]
    field_object_formal[dsph]='Indus 2'
    ...
    field_object_formal[dsph]='Tucana 4'
...
#                infile=fitsfile[i].split('.fits')[0]+'_postfit_ian.fits'
                ...
                for j in range(0,len(postfit[6].data)):
                    ...
                    postfit_temperature.append(postfit[6].data['temperature'][j])
                    short_filename=infile.split('/ut2')[1][8:].split('_with_posterior.fits')[0]+'.fits'
        ...
        s1=np.array([postfit_mean[q][14] for q in range(0,len(postfit_mean))])
        s1_sig=np.array([postfit_std[q][14] for q in range(0,len(postfit_std))])
        s1_skew=np.array([postfit_skew[q][14] for q in range(0,len(postfit_skew))])
        s1_kurt=np.array([postfit_kurtosis[q][14] for q in range(0,len(postfit_kurtosis))])
        s2=np.array([postfit_mean[q][15] for q in range(0,len(postfit_mean))])
        s2_sig=np.array([postfit_std[q][15] for q in range(0,len(postfit_std))])
        s2_skew=np.array([postfit_skew[q][15] for q in range(0,len(postfit_skew))])
        s2_kurt=np.array([postfit_kurtosis[q][15] for q in range(0,len(postfit_kurtosis))])
        ...
        teffprior_s1=np.array([postfit_teffprior_mean[q][14] for q in range(0,len(postfit_teffprior_mean))])
        teffprior_s1_sig=np.array([postfit_teffprior_std[q][14] for q in range(0,len(postfit_teffprior_std))])
        teffprior_s1_skew=np.array([postfit_teffprior_skew[q][14] for q in range(0,len(postfit_teffprior_skew))])
        teffprior_s1_kurt=np.array([postfit_teffprior_kurtosis[q][14] for q in range(0,len(postfit_teffprior_kurtosis))])
        teffprior_s2=np.array([postfit_teffprior_mean[q][15] for q in range(0,len(postfit_teffprior_mean))])
        teffprior_s2_sig=np.array([postfit_teffprior_std[q][15] for q in range(0,len(postfit_teffprior_std))])
        teffprior_s2_skew=np.array([postfit_teffprior_skew[q][15] for q in range(0,len(postfit_teffprior_skew))])
        teffprior_s2_kurt=np.array([postfit_teffprior_kurtosis[q][15] for q in range(0,len(postfit_teffprior_kurtosis))])
        ...
        col39=fits.Column(name='logs1_raw',format='D',array=s1[targets],unit='Angstrom')
        col40=fits.Column(name='logs1_raw_error',format='D',array=s1_sig[targets],unit='Angstrom')
        col41=fits.Column(name='logs1_raw_skew',format='D',array=s1_skew[targets],unit='')
        col42=fits.Column(name='logs1_raw_kurtosis',format='D',array=s1_kurt[targets],unit='')
        col43=fits.Column(name='logs1_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='Angstrom')
        col44=fits.Column(name='logs2_raw',format='D',array=s2[targets],unit='Angstrom')
        col45=fits.Column(name='logs2_raw_error',format='D',array=s2_sig[targets],unit='Angstrom')
        col46=fits.Column(name='logs2_raw_skew',format='D',array=s2_skew[targets],unit='')
        col47=fits.Column(name='logs2_raw_kurtosis',format='D',array=s2_kurt[targets],unit='')
        col48=fits.Column(name='logs2_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='Angstrom')
        col49=fits.Column(name='teffprior_vlos_raw',format='D',array=teffprior_v[targets],unit='km/s')
        col50=fits.Column(name='teffprior_vlos_raw_error',format='D',array=teffprior_v_sig[targets],unit='km/s')
        col51=fits.Column(name='teffprior_vlos_raw_skew',format='D',array=teffprior_v_skew[targets],unit='')
        col52=fits.Column(name='teffprior_vlos_raw_kurtosis',format='D',array=teffprior_v_kurt[targets],unit='')
        col53=fits.Column(name='teffprior_vlos_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='km/s')
        col54=fits.Column(name='teffprior_teff_raw',format='D',array=teffprior_teff[targets],unit='Kelvin')
        col55=fits.Column(name='teffprior_teff_raw_error',format='D',array=teffprior_teff_sig[targets],unit='Kelvin')
        col56=fits.Column(name='teffprior_teff_raw_skew',format='D',array=teffprior_teff_skew[targets],unit='')
        col57=fits.Column(name='teffprior_teff_raw_kurtosis',format='D',array=teffprior_teff_kurt[targets],unit='')
        col58=fits.Column(name='teffprior_teff_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='Kelvin')
        col59=fits.Column(name='teffprior_logg_raw',format='D',array=teffprior_logg[targets],unit='dex (cgs)')
        col60=fits.Column(name='teffprior_logg_raw_error',format='D',array=teffprior_logg_sig[targets],unit='dex (cgs)')
        col61=fits.Column(name='teffprior_logg_raw_skew',format='D',array=teffprior_logg_skew[targets],unit='')
        col62=fits.Column(name='teffprior_logg_raw_kurtosis',format='D',array=teffprior_logg_kurt[targets],unit='')
        col63=fits.Column(name='teffprior_logg_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='dex (cgs)')
        col64=fits.Column(name='teffprior_feh_raw',format='D',array=teffprior_z[targets],unit='dex')
        col65=fits.Column(name='teffprior_feh_raw_error',format='D',array=teffprior_z_sig[targets],unit='dex')
        col66=fits.Column(name='teffprior_feh_raw_skew',format='D',array=teffprior_z_skew[targets],unit='')
        col67=fits.Column(name='teffprior_feh_raw_kurtosis',format='D',array=teffprior_z_kurt[targets],unit='')
        col68=fits.Column(name='teffprior_feh_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='dex')
        col69=fits.Column(name='teffprior_mgfe_raw',format='D',array=teffprior_mgfe[targets],unit='dex')
        col70=fits.Column(name='teffprior_mgfe_raw_error',format='D',array=teffprior_mgfe_sig[targets],unit='dex')
        col71=fits.Column(name='teffprior_mgfe_raw_skew',format='D',array=teffprior_mgfe_skew[targets],unit='')
        col72=fits.Column(name='teffprior_mgfe_raw_kurtosis',format='D',array=teffprior_mgfe_kurt[targets],unit='')
        col73=fits.Column(name='teffprior_mgfe_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='dex')
        col74=fits.Column(name='teffprior_smooth_raw',format='D',array=teffprior_smooth[targets],unit='Angstrom')
        col75=fits.Column(name='teffprior_smooth_raw_error',format='D',array=teffprior_smooth_sig[targets],unit='Angstrom')
        col76=fits.Column(name='teffprior_smooth_raw_skew',format='D',array=teffprior_smooth_skew[targets],unit='')
        col77=fits.Column(name='teffprior_smooth_raw_kurtosis',format='D',array=teffprior_smooth_kurt[targets],unit='')
        col78=fits.Column(name='teffprior_smooth_error',format='D',array=np.full(len(targets),np.nan,dtype='float'),unit='Angstrom')
        col79=fits.Column(name='teffprior_survey',format='A10',array=teffprior_survey[targets],unit='')

        col80=fits.Column(name='median_sky',format='D',array=postfit_mediansky[targets],unit='electron')
        col81=fits.Column(name='median_skysub',format='D',array=postfit_medianskysub[targets],unit='electron')
        col82=fits.Column(name='standard_deviation_median_sky',format='D',array=postfit_stdsky[targets],unit='electron')
        col83=fits.Column(name='filter_name',format='A100',array=postfit_filtername[targets],unit='')
        col84=fits.Column(name='chi2',format='D',array=postfit_chi2[targets],unit='')
        col85=fits.Column(name='chi2_rescaled',format='D',array=postfit_chi22[targets],unit='')
        col86=fits.Column(name='npix',format='D',array=postfit_n[targets],unit='')
        col87=fits.Column(name='w5163',format='D',array=postfit_bluespec[targets],unit='electron')
        col88=fits.Column(name='w5180',format='D',array=postfit_redspec[targets],unit='electron')
        col89=fits.Column(name='vhelio_correction',format='D',array=postfit_vhelio_correction[targets],unit='km/s')
        col90=fits.Column(name='fits_filename',format='A200',array=postfit_filename[targets],unit='')
        col91=fits.Column(name='fits_index',format='I',array=postfit_index[targets],unit='')

        col92=fits.Column(name='gaia_source_id',format='K',array=postfit_gaiaid[targets],unit='')
        col93=fits.Column(name='gaia_gmag',format='D',array=postfit_gaiagmag[targets],unit='mag')
        col94=fits.Column(name='gaia_siggmag',format='D',array=postfit_siggaiagmag[targets],unit='mag')
        col95=fits.Column(name='gaia_gmag_dered',format='D',array=postfit_gaiagmag_dered[targets],unit='mag')
        col96=fits.Column(name='gaia_bpmag',format='D',array=postfit_gaiabpmag[targets],unit='mag')
        col97=fits.Column(name='gaia_sigbpmag',format='D',array=postfit_siggaiabpmag[targets],unit='mag')
        col98=fits.Column(name='gaia_bpmag_dered',format='D',array=postfit_gaiabpmag_dered[targets],unit='mag')
        col99=fits.Column(name='gaia_rpmag',format='D',array=postfit_gaiarpmag[targets],unit='mag')
        col100=fits.Column(name='gaia_sigrpmag',format='D',array=postfit_siggaiarpmag[targets],unit='mag')
        col101=fits.Column(name='gaia_rpmag_dered',format='D',array=postfit_gaiarpmag_dered[targets],unit='mag')
        col102=fits.Column(name='gaia_pmra',format='D',array=postfit_gaiapmra[targets],unit='mas/yr')
        col103=fits.Column(name='gaia_sigpmra',format='D',array=postfit_siggaiapmra[targets],unit='mas/yr')
        col104=fits.Column(name='gaia_pmdec',format='D',array=postfit_gaiapmdec[targets],unit='mas/yr')
        col105=fits.Column(name='gaia_sigpmdec',format='D',array=postfit_siggaiapmdec[targets],unit='mas/yr')
        col106=fits.Column(name='gaia_parallax',format='D',array=postfit_gaiaparallax[targets],unit='mas')
        col107=fits.Column(name='gaia_sigparallax',format='D',array=postfit_siggaiaparallax[targets],unit='mas')
        col108=fits.Column(name='gaia_rrl',format='I',array=postfit_gaia_rrl[targets],unit='')
        col109=fits.Column(name='gaia_cepheid',format='I',array=postfit_gaia_cepheid[targets],unit='')
        col110=fits.Column(name='gaia_agn',format='I',array=postfit_gaia_agn[targets],unit='')
        col111=fits.Column(name='gaia_rv_variable',format='I',array=postfit_gaia_rvvariable[targets],unit='')
        col112=fits.Column(name='gaia_compact_companion',format='I',array=postfit_gaia_compact[targets],unit='')
        col113=fits.Column(name='gaia_radial_velocity',format='D',array=postfit_gaia_rv[targets],unit='km/s')
        col114=fits.Column(name='gaia_radial_velocity_error',format='D',array=postfit_gaia_sigrv[targets],unit='km/s')
        col115=fits.Column(name='gaia_phot_variable_flag',format='A20',array=postfit_gaia_phot_variable[targets],unit='')
        col116=fits.Column(name='gaia_in_qso_candidates',format='L',array=postfit_gaia_in_qso[targets],unit='')
        col117=fits.Column(name='gaia_in_galaxy_candidates',format='L',array=postfit_gaia_in_galaxy[targets],unit='')
        col118=fits.Column(name='gaia_non_single_star',format='I',array=postfit_gaia_in_blend[targets],unit='')
        col119=fits.Column(name='gaia_teff_gspphot',format='D',array=postfit_gaia_teff[targets],unit='Kelvin')
        col120=fits.Column(name='gaia_teff_gspphot_lower',format='D',array=postfit_gaia_teff_lower[targets],unit='Kelvin')
        col121=fits.Column(name='gaia_teff_gspphot_upper',format='D',array=postfit_gaia_teff_upper[targets],unit='Kelvin')
        col122=fits.Column(name='gaia_logg_gspphot',format='D',array=postfit_gaia_logg[targets],unit='dex (cgs)')
        col123=fits.Column(name='gaia_logg_gspphot_lower',format='D',array=postfit_gaia_logg_lower[targets],unit='dex (cgs)')
        col124=fits.Column(name='gaia_logg_gspphot_upper',format='D',array=postfit_gaia_logg_upper[targets],unit='dex (cgs)')
        col125=fits.Column(name='gaia_mh_gspphot',format='D',array=postfit_gaia_feh[targets],unit='dex')
        col126=fits.Column(name='gaia_mh_gspphot_lower',format='D',array=postfit_gaia_feh_lower[targets],unit='dex')
        col127=fits.Column(name='gaia_mh_gspphot_upper',format='D',array=postfit_gaia_feh_upper[targets],unit='dex')
        col128=fits.Column(name='gaia_libname_gspphot',format='A30',array=postfit_gaia_libname[targets],unit='')
        col129=fits.Column(name='exptime',format='D',array=postfit_exptime[targets],unit='second')
        col130=fits.Column(name='n_subexp',format='D',array=postfit_nsubexp[targets],unit='')
        col131=fits.Column(name='airmass',format='D',array=postfit_airmass[targets],unit='')
        col132=fits.Column(name='run_id',format='A100',array=postfit_run_id[targets],unit='')
        col133=fits.Column(name='wav_npoints',format='PI()',array=postfit_wav_npoints[targets],unit='')
        col134=fits.Column(name='wav_rms',format='PD()',array=postfit_wav_rms[targets],unit='Angstrom')
        col135=fits.Column(name='wav_resolution',format='PD()',array=postfit_wav_resolution[targets],unit='Angstrom')
        col136=fits.Column(name='wav_min',format='PD()',array=postfit_wav_min[targets],unit='Angstrom')
        col137=fits.Column(name='wav_max',format='PD()',array=postfit_wav_max[targets],unit='Angstrom')
        col138=fits.Column(name='row',format='D',array=postfit_row[targets],unit='')
        col139=fits.Column(name='temperature',format='PD()',array=postfit_temperature[targets],unit='degree Celcius')
...
#    keep=np.where((catalog_sorted['vlos_raw']==catalog_sorted['vlos_raw'])&(catalog_sorted['vlos_raw_error']<5.)&(catalog_sorted['filtername']=='HiRes')&(catalog_sorted['sn_ratio']>0.)&(gaiaid>0.))[0]
        ...
        if filtername0=='HiRes':
            string='\\newcommand{\mtwofshiresnrepeatv}{'+str(len(repeat_ind1))+'} \n'
        if filtername0=='MedRes':
...
#        thing_dmax=np.array([5.,5.,2000.,2000.,2.5,2.5,2.5,2.5,1.,1.,0.03,0.03])
...
#            catalog[thing[k]+'_error']=10.**bestfit['parameters'][0]+10.**bestfit['parameters'][1]*catalog_raw[1].data[thing[k]+'_raw_error']
            catalog[thing[k]+'_error']=np.sqrt((10.**bestfit['parameters'][0])**2+(10.**bestfit['parameters'][1]*catalog_raw[1].data[thing[k]+'_raw_error'])**2)
