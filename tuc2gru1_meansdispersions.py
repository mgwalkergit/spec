...
for line in data: # fill arrays
    ...
    tuc2_vdisp.append(float(p[1]))
    tuc2_vgrad.append(float(p[2]))
    tuc2_vtheta.append(float(p[3]))
    tuc2_fehmean.append(float(p[4]))
    tuc2_fehdisp.append(float(p[5]))
    tuc2_fehgrad.append(float(p[6]))
    tuc2_like.append(float(p[7]))
...
for line in data: # fill arrays
    ...
    gru1_vdisp.append(float(p[1]))
    gru1_vgrad.append(float(p[2]))
    gru1_vtheta.append(float(p[3]))
    gru1_fehmean.append(float(p[4]))
    gru1_fehdisp.append(float(p[5]))
    gru1_fehgrad.append(float(p[6]))
    gru1_like.append(float(p[7]))
...
plotfilename='tuc2gru1_meansdispersions.pdf'
