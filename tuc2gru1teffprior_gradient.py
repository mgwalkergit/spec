...
out1='tuc2gru1teffprior_gradientcommands.tex'
out2='tuc2gru1teffprior_gradient_table.tex'
g1=open(out1,'w')
g2=open(out2,'w')
...
ax0_0.hist(tuc2_vmean,bins=50,range=vmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5,label='Tuc II')
ax0_0.hist(gru1_vmean,bins=50,range=vmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='b',linewidth=0.5,label='Gru I')
...
g2.write(r'\hline'+'\n')
g2.write(r'parameter & prior & posterior: Tuc II & posterior: Gru I & description\\'+'\n')
...
g2.write(r'$\langle v_{\rm los}\rangle$ [km s$^{-1}$] & uniform between -500 and +500 & \tucvmeanexpanded & \gruvmeanexpanded '+r'& mean velocity at center' +r'\\'+'\n')
g2.write(r'\smallskip'+'\n')
#g2.write(r'$\sigma_{v_{\rm los}}$ [km s$^{-1}$] & uniform between 0 and +500 & \vdispexpanded & \vdisptwoexpanded '+r'& velocity dispersion' +r'\\'+'\n')
g2.write(r'$\sigma_{v_{\rm los}}$ [km s$^{-1}$] & uniform between 0 and +500 & \tucvdispexpanded & \gruvdispexpanded '+r'& velocity dispersion' +r'\\'+'\n')
g2.write(r'\smallskip'+'\n')
...
g2.write(r'$k_{v_{\rm los}}$ [km s$^{-1}$ arcmin$^{-1}$] & uniform between 0 and +10 & \tucvgradexpanded & \gruvgradexpanded '+r'& magnitude of maximum velocity gradient' +r'\\'+'\n')
g2.write(r'\smallskip'+'\n')
...
g2.write(r'$\theta_{v_{\rm los}}$ [$\degr$] & uniform between -180 and +180 & \tucvthetaexpanded & \gruvthetaexpanded '+r'& direction of maximum velocity gradient' +r'\\'+'\n')
g2.write(r'\smallskip'+'\n')
#g2.write(r'$\langle \feh\rangle $ & uniform between -5 and +1 & \fehmeanexpanded & \fehmeantwoexpanded '+r'& mean metallicity at center' +r'\\'+'\n')
g2.write(r'$\langle \feh\rangle $ & uniform between -5 and +1 & \tucfehmeanexpanded & \grufehmeanexpanded '+r'& mean metallicity at center' +r'\\'+'\n')
g2.write(r'\smallskip'+'\n')
#g2.write(r'$\sigma_{\feh}$ & uniform between 0 and +2 & \fehdispexpanded & \fehdisptwoexpanded '+r'& metallicity dispersion' +r'\\'+'\n')
g2.write(r'$\sigma_{\feh}$ & uniform between 0 and +2 & \tucfehdispexpanded & \grufehdispexpanded '+r'& metallicity dispersion' +r'\\'+'\n')
g2.write(r'\smallskip'+'\n')
...
g2.write(r'$k_{\feh}$ [dex arcmin$^{-1}$] & uniform between -1 and 0 & \tucfehgradexpanded & \grufehgradexpanded '+r'& magnitude of metallicity gradient' +r'\\'+'\n')
...
g1.close()
g2.close()
plotfilename='tuc2gru1teffprior_gradient.pdf'
