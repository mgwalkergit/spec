...
with open(directory+m2fsrun+'_11_science_raw') as f: 
    data=f.readlines()[0:]
for line in data:
    p=line.split()
    if p[0]!='none':
...
#                    hjdstring=str(round(new_hdul[5].data['hjd'][0],2))
                    fits_file=root0+'_'+new_hdul[0].header['ut-date']+'_'+new_hdul[0].header['ut-time']+'_skysubtract_noflat.fits'
...
#                hjdstring=str(round(new_hdul[5].data['hjd'][0],2))
                stack_fits_file=root2+'_'+new_hdul[0].header['ut-date']+'_'+new_hdul[0].header['ut-time']+'_stackskysub_noflat.fits'
                stack_fits_file2=root2+'_'+new_hdul[0].header['ut-date']+'_'+new_hdul[0].header['ut-time']+'_stackskysub_noflat_file'
...
#                        g1.close()
        ...
        if cheat_id_lines_translate:
            ...
            for j in range(0,len(tharfile0[i])):
                ...
                extract1d_array_file=root0+'_extract1d_array_noflat.pickle'
                id_lines_array_file=root0+'_id_lines_array_noflat.pickle'
                cheat_id_lines_array_file=root0+'_cheat_id_lines_array_noflat.pickle'
