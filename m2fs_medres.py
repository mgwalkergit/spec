...
fits_table_final_filename='/hildafs/projects/phy200028p/mgwalker/m2fs/m2fs_medres_fits_table.fits'
...
if get_obstable:
    ...
    for i in range(0,len(fitsfile)):
        ...
        elif 'HiRes' in filtername:
            sum=4.
        else:
            print('ERROR: unidentified filtername')
            np.pause()

    obs_out=open('m2fs_medres_obs_newcommands.tex','w')
    obs_out.write('\\newcommand{\mtwofsmedresnfieldstot}{'+str(nfields_total)+'} \n')
    obs_out.write('\\newcommand{\mtwofsmedresexptimetot}{'+str(round(exptime_total/1.e6,2))+'} \n')
    obs_out.close()
    ...
    out_table=open('m2fs_medres_obs_table.tex','w')
    out_table_short=open('m2fs_medres_obs_table_short.tex','w')
    ...
    pickle.dump(field_center,open('m2fs_medres_field_center.pkl','wb'))
...
if get_fits:
    ...
    for i in range(0,len(fitsfile)):
        ...
        print(filtername)
        if ((len(fitsobject.obj)>0)&(filtername=='Mgb_MedRes')):
            ...
            col3=fits.Column(name='ra_dec_source',format='A30',array=ra_dec_source)
            col4=fits.Column(name='mjd',format='D',array=fitsobject.mjd)
            col5=fits.Column(name='hjd',format='D',array=fitsobject.hjd)
            col6=fits.Column(name='snratio',format='D',array=fitsobject.snratio)
            col7=fits.Column(name='vhelio_correction',format='D',array=fitsobject.vheliocorr)
            ...
            col12=fits.Column(name='teffprior_survey',format='A10',array=multinest.teffprior_survey)
            col13=fits.Column(name='objtype',format='A6',array=fitsobject.obj)
            col14=fits.Column(name='run_id',format='A100',array=fitsobject.run_id)
            col15=fits.Column(name='field_name',format='A100',array=fitsobject.field_name)
            col16=fits.Column(name='filter_name',format='A100',array=fitsobject.filtername)
            col17=fits.Column(name='wav_npoints',format='PI()',array=fitsobject.wav_npoints)
            col18=fits.Column(name='wav_rms',format='PD()',array=fitsobject.wav_rms)
            col19=fits.Column(name='wav_resolution',format='PD()',array=fitsobject.wav_resolution)
            col20=fits.Column(name='wav_min',format='PD()',array=fitsobject.wav_min)
            col21=fits.Column(name='wav_max',format='PD()',array=fitsobject.wav_max)
            col22=fits.Column(name='row',format='D',array=fitsobject.row)
            col23=fits.Column(name='temperature',format='PD()',array=fitsobject.temperature)
            col24=fits.Column(name='gaia_source_id',format='A30',array=survey_phot.gaia.objid)
            col25=fits.Column(name='gaia_gmag',format='D',array=survey_phot.gaia.gmag)
            col26=fits.Column(name='gaia_siggmag',format='D',array=survey_phot.gaia.siggmag)
            col27=fits.Column(name='gaia_gmag_dered',format='D',array=gaia_gmag_dered)
            col28=fits.Column(name='gaia_bpmag',format='D',array=survey_phot.gaia.bpmag)
            col29=fits.Column(name='gaia_sigbpmag',format='D',array=survey_phot.gaia.sigbpmag)
            col30=fits.Column(name='gaia_bpmag_dered',format='D',array=gaia_bpmag_dered)
            col31=fits.Column(name='gaia_rpmag',format='D',array=survey_phot.gaia.rpmag)
            col32=fits.Column(name='gaia_sigrpmag',format='D',array=survey_phot.gaia.sigrpmag)
            col33=fits.Column(name='gaia_rpmag_dered',format='D',array=gaia_rpmag_dered)
            col34=fits.Column(name='gaia_pmra',format='D',array=survey_phot.gaia.pmra)
            col35=fits.Column(name='gaia_sigpmra',format='D',array=survey_phot.gaia.sigpmra)
            col36=fits.Column(name='gaia_pmdec',format='D',array=survey_phot.gaia.pmdec)
            col37=fits.Column(name='gaia_sigpmdec',format='D',array=survey_phot.gaia.sigpmdec)
            col38=fits.Column(name='gaia_parallax',format='D',array=survey_phot.gaia.parallax)
            col39=fits.Column(name='gaia_sigparallax',format='D',array=survey_phot.gaia.sigparallax)
            col40=fits.Column(name='gaia_rrl',format='I',array=survey_phot.gaia.rrl)
            col41=fits.Column(name='gaia_cepheid',format='I',array=survey_phot.gaia.cepheid)
            col42=fits.Column(name='gaia_agn',format='I',array=survey_phot.gaia.agn)
            col43=fits.Column(name='gaia_rvvariable',format='I',array=survey_phot.gaia.rvvariable)
            col44=fits.Column(name='gaia_compact',format='I',array=survey_phot.gaia.compact)
            col45=fits.Column(name='gaia_rv',format='D',array=survey_phot.gaia.rv)
            col46=fits.Column(name='gaia_sigrv',format='D',array=survey_phot.gaia.sigrv)
            col47=fits.Column(name='gaia_phot_variable',format='A20',array=survey_phot.gaia.variable)
            col48=fits.Column(name='gaia_in_qso',format='L',array=survey_phot.gaia.in_qso)
            col49=fits.Column(name='gaia_in_galaxy',format='L',array=survey_phot.gaia.in_galaxy)
            col50=fits.Column(name='gaia_in_blend',format='I',array=survey_phot.gaia.in_blend)
            col51=fits.Column(name='gaia_teff',format='D',array=survey_phot.gaia.teff)
            col52=fits.Column(name='gaia_teff_lower',format='D',array=survey_phot.gaia.teff_lower)
            col53=fits.Column(name='gaia_teff_upper',format='D',array=survey_phot.gaia.teff_upper)
            col54=fits.Column(name='gaia_logg',format='D',array=survey_phot.gaia.logg)
            col55=fits.Column(name='gaia_logg_lower',format='D',array=survey_phot.gaia.logg_lower)
            col56=fits.Column(name='gaia_logg_upper',format='D',array=survey_phot.gaia.logg_upper)
            col57=fits.Column(name='gaia_feh',format='D',array=survey_phot.gaia.feh)
            col58=fits.Column(name='gaia_feh_lower',format='D',array=survey_phot.gaia.feh_lower)
            col59=fits.Column(name='gaia_feh_upper',format='D',array=survey_phot.gaia.feh_upper)
            col60=fits.Column(name='gaia_libname',format='A30',array=survey_phot.gaia.libname)
...
if get_catalog_raw:
    ...
    targets=np.where((postfit_objtype=='TARGET')&(v_sig>1.e-10)&(teff_sig>1.e-10)&(logg_sig>1.e-10)&(z_sig>1.e-10)&(postfit_filtername=='LoRes'))[0]
    col1=fits.Column(name='instrument',format='A20',array=np.full(len(targets),'M2FS',dtype='str'))
    col2=fits.Column(name='target_system',format='A100',array=postfit_object[targets])
    col3=fits.Column(name='obj_id',format='A100',array=postfit_obsid[targets])
    col4=fits.Column(name='ra_deg',format='D',array=postfit_radeg[targets])
    col5=fits.Column(name='dec_deg',format='D',array=postfit_decdeg[targets])
    col6=fits.Column(name='ra_dec_source',format='A30',array=postfit_ra_dec_source[targets])
    col7=fits.Column(name='hjd',format='D',array=postfit_hjd[targets])
    col8=fits.Column(name='sn_ratio',format='D',array=postfit_snratio[targets])

    col9=fits.Column(name='vlos_raw',format='D',array=v[targets])
    col10=fits.Column(name='vlos_raw_error',format='D',array=v_sig[targets])
    col11=fits.Column(name='vlos_raw_skew',format='D',array=v_skew[targets])
    col12=fits.Column(name='vlos_raw_kurtosis',format='D',array=v_kurt[targets])
    col13=fits.Column(name='vlos_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col14=fits.Column(name='teff_raw',format='D',array=teff[targets])
    col15=fits.Column(name='teff_raw_error',format='D',array=teff_sig[targets])
    col16=fits.Column(name='teff_raw_skew',format='D',array=teff_skew[targets])
    col17=fits.Column(name='teff_raw_kurtosis',format='D',array=teff_kurt[targets])
    col18=fits.Column(name='teff_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col19=fits.Column(name='logg_raw',format='D',array=logg[targets])
    col20=fits.Column(name='logg_raw_error',format='D',array=logg_sig[targets])
    col21=fits.Column(name='logg_raw_skew',format='D',array=logg_skew[targets])
    col22=fits.Column(name='logg_raw_kurtosis',format='D',array=logg_kurt[targets])
    col23=fits.Column(name='logg_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col24=fits.Column(name='feh_raw',format='D',array=z[targets])
    col25=fits.Column(name='feh_raw_error',format='D',array=z_sig[targets])
    col26=fits.Column(name='feh_raw_skew',format='D',array=z_skew[targets])
    col27=fits.Column(name='feh_raw_kurtosis',format='D',array=z_kurt[targets])
    col28=fits.Column(name='feh_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col29=fits.Column(name='mgfe_raw',format='D',array=mgfe[targets])
    col30=fits.Column(name='mgfe_raw_error',format='D',array=mgfe_sig[targets])
    col31=fits.Column(name='mgfe_raw_skew',format='D',array=mgfe_skew[targets])
    col32=fits.Column(name='mgfe_raw_kurtosis',format='D',array=mgfe_kurt[targets])
    col33=fits.Column(name='mgfe_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col34=fits.Column(name='smooth_raw',format='D',array=smooth[targets])
    col35=fits.Column(name='smooth_raw_error',format='D',array=smooth_sig[targets])
    col36=fits.Column(name='smooth_raw_skew',format='D',array=smooth_skew[targets])
    col37=fits.Column(name='smooth_raw_kurtosis',format='D',array=smooth_kurt[targets])
    col38=fits.Column(name='smooth_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))

    col39=fits.Column(name='teffprior_vlos_raw',format='D',array=teffprior_v[targets])
    col40=fits.Column(name='teffprior_vlos_raw_error',format='D',array=teffprior_v_sig[targets])
    col41=fits.Column(name='teffprior_vlos_raw_skew',format='D',array=teffprior_v_skew[targets])
    col42=fits.Column(name='teffprior_vlos_raw_kurtosis',format='D',array=teffprior_v_kurt[targets])
    col43=fits.Column(name='teffprior_vlos_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col44=fits.Column(name='teffprior_teff_raw',format='D',array=teffprior_teff[targets])
    col45=fits.Column(name='teffprior_teff_raw_error',format='D',array=teffprior_teff_sig[targets])
    col46=fits.Column(name='teffprior_teff_raw_skew',format='D',array=teffprior_teff_skew[targets])
    col47=fits.Column(name='teffprior_teff_raw_kurtosis',format='D',array=teffprior_teff_kurt[targets])
    col48=fits.Column(name='teffprior_teff_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col49=fits.Column(name='teffprior_logg_raw',format='D',array=teffprior_logg[targets])
    col50=fits.Column(name='teffprior_logg_raw_error',format='D',array=teffprior_logg_sig[targets])
    col51=fits.Column(name='teffprior_logg_raw_skew',format='D',array=teffprior_logg_skew[targets])
    col52=fits.Column(name='teffprior_logg_raw_kurtosis',format='D',array=teffprior_logg_kurt[targets])
    col53=fits.Column(name='teffprior_logg_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col54=fits.Column(name='teffprior_feh_raw',format='D',array=teffprior_z[targets])
    col55=fits.Column(name='teffprior_feh_raw_error',format='D',array=teffprior_z_sig[targets])
    col56=fits.Column(name='teffprior_feh_raw_skew',format='D',array=teffprior_z_skew[targets])
    col57=fits.Column(name='teffprior_feh_raw_kurtosis',format='D',array=teffprior_z_kurt[targets])
    col58=fits.Column(name='teffprior_feh_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col59=fits.Column(name='teffprior_mgfe_raw',format='D',array=teffprior_mgfe[targets])
    col60=fits.Column(name='teffprior_mgfe_raw_error',format='D',array=teffprior_mgfe_sig[targets])
    col61=fits.Column(name='teffprior_mgfe_raw_skew',format='D',array=teffprior_mgfe_skew[targets])
    col62=fits.Column(name='teffprior_mgfe_raw_kurtosis',format='D',array=teffprior_mgfe_kurt[targets])
    col63=fits.Column(name='teffprior_mgfe_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col64=fits.Column(name='teffprior_smooth_raw',format='D',array=teffprior_smooth[targets])
    col65=fits.Column(name='teffprior_smooth_raw_error',format='D',array=teffprior_smooth_sig[targets])
    col66=fits.Column(name='teffprior_smooth_raw_skew',format='D',array=teffprior_smooth_skew[targets])
    col67=fits.Column(name='teffprior_smooth_raw_kurtosis',format='D',array=teffprior_smooth_kurt[targets])
    col68=fits.Column(name='teffprior_smooth_error',format='D',array=np.full(len(targets),np.nan,dtype='float'))
    col69=fits.Column(name='teffprior_survey',format='A10',array=teffprior_survey[targets])

    col70=fits.Column(name='median_sky',format='D',array=postfit_mediansky[targets])
    col71=fits.Column(name='standard_deviation_median_sky',format='D',array=postfit_stdsky[targets])
    col72=fits.Column(name='filter_name',format='A100',array=postfit_filtername[targets])
    col73=fits.Column(name='chi2',format='D',array=postfit_chi2[targets])
    col74=fits.Column(name='chi2_rescaled',format='D',array=postfit_chi22[targets])
    col75=fits.Column(name='n',format='D',array=postfit_n[targets])
    col76=fits.Column(name='w5163',format='D',array=postfit_bluespec[targets])
    col77=fits.Column(name='w5180',format='D',array=postfit_redspec[targets])
    col78=fits.Column(name='vhelio_correction',format='D',array=postfit_vhelio_correction[targets])
    col79=fits.Column(name='fits_filename',format='A200',array=postfit_filename[targets])
    col80=fits.Column(name='fits_index',format='I',array=postfit_index[targets])

    col81=fits.Column(name='gaia_source_id',format='A30',array=postfit_gaiaid[targets])
    col82=fits.Column(name='gaia_gmag',format='D',array=postfit_gaiagmag[targets])
    col83=fits.Column(name='gaia_siggmag',format='D',array=postfit_siggaiagmag[targets])
    col84=fits.Column(name='gaia_gmag_dered',format='D',array=postfit_gaiagmag_dered[targets])
    col85=fits.Column(name='gaia_bpmag',format='D',array=postfit_gaiabpmag[targets])
    col86=fits.Column(name='gaia_sigbpmag',format='D',array=postfit_siggaiabpmag[targets])
    col87=fits.Column(name='gaia_bpmag_dered',format='D',array=postfit_gaiabpmag_dered[targets])
    col88=fits.Column(name='gaia_rpmag',format='D',array=postfit_gaiarpmag[targets])
    col89=fits.Column(name='gaia_sigrpmag',format='D',array=postfit_siggaiarpmag[targets])
    col90=fits.Column(name='gaia_rpmag_dered',format='D',array=postfit_gaiarpmag_dered[targets])
    col91=fits.Column(name='gaia_pmra',format='D',array=postfit_gaiapmra[targets])
    col92=fits.Column(name='gaia_sigpmra',format='D',array=postfit_siggaiapmra[targets])
    col93=fits.Column(name='gaia_pmdec',format='D',array=postfit_gaiapmdec[targets])
    col94=fits.Column(name='gaia_sigpmdec',format='D',array=postfit_siggaiapmdec[targets])
    col95=fits.Column(name='gaia_parallax',format='D',array=postfit_gaiaparallax[targets])
    col96=fits.Column(name='gaia_sigparallax',format='D',array=postfit_siggaiaparallax[targets])
    col97=fits.Column(name='gaia_rrl',format='I',array=postfit_gaia_rrl[targets])
    col98=fits.Column(name='gaia_cepheid',format='I',array=postfit_gaia_cepheid[targets])
    col99=fits.Column(name='gaia_agn',format='I',array=postfit_gaia_agn[targets])
    col100=fits.Column(name='gaia_rv_variable',format='I',array=postfit_gaia_rvvariable[targets])
    col101=fits.Column(name='gaia_compact_companion',format='I',array=postfit_gaia_compact[targets])
    col102=fits.Column(name='gaia_radial_velocity',format='D',array=postfit_gaia_rv[targets])
    col103=fits.Column(name='gaia_radial_velocity_error',format='D',array=postfit_gaia_sigrv[targets])
    col104=fits.Column(name='gaia_phot_variable_flag',format='A20',array=postfit_gaia_phot_variable[targets])
    col105=fits.Column(name='gaia_in_qso_candidates',format='L',array=postfit_gaia_in_qso[targets])
    col106=fits.Column(name='gaia_in_galaxy_candidates',format='L',array=postfit_gaia_in_galaxy[targets])
    col107=fits.Column(name='gaia_non_single_star',format='I',array=postfit_gaia_in_blend[targets])
    col108=fits.Column(name='gaia_teff_gspphot',format='D',array=postfit_gaia_teff[targets])
    col109=fits.Column(name='gaia_teff_gspphot_lower',format='D',array=postfit_gaia_teff_lower[targets])
    col110=fits.Column(name='gaia_teff_gspphot_upper',format='D',array=postfit_gaia_teff_upper[targets])
    col111=fits.Column(name='gaia_logg_gspphot',format='D',array=postfit_gaia_logg[targets])
    col112=fits.Column(name='gaia_logg_gspphot_lower',format='D',array=postfit_gaia_logg_lower[targets])
    col113=fits.Column(name='gaia_logg_gspphot_upper',format='D',array=postfit_gaia_logg_upper[targets])
    col114=fits.Column(name='gaia_mh_gspphot',format='D',array=postfit_gaia_feh[targets])
    col115=fits.Column(name='gaia_mh_gspphot_lower',format='D',array=postfit_gaia_feh_lower[targets])
    col116=fits.Column(name='gaia_mh_gspphot_upper',format='D',array=postfit_gaia_feh_upper[targets])
    col117=fits.Column(name='gaia_libname_gspphot',format='A30',array=postfit_gaia_libname[targets])
    
    col118=fits.Column(name='run_id',format='A100',array=postfit_run_id[targets])
    col119=fits.Column(name='wav_npoints',format='PI()',array=postfit_wav_npoints[targets])
    col120=fits.Column(name='wav_rms',format='PD()',array=postfit_wav_rms[targets])
    col121=fits.Column(name='wav_resolution',format='PD()',array=postfit_wav_resolution[targets])
    col122=fits.Column(name='wav_min',format='PD()',array=postfit_wav_min[targets])
    col123=fits.Column(name='wav_max',format='PD()',array=postfit_wav_max[targets])
    col124=fits.Column(name='row',format='D',array=postfit_row[targets])
    col125=fits.Column(name='temperature',format='PD()',array=postfit_temperature[targets])
...
if get_errors:
    ...
    g0=open('m2fs_medres_error_adjust.tex','w')
    ...
    keep=np.where((catalog_sorted['vlos_raw']==catalog_sorted['vlos_raw'])&(catalog_sorted['vlos_raw_error']<5.)&(catalog_sorted['filter_name']=='LoRes')&(catalog_sorted['sn_ratio']>0.)&(gaiaid>0.)&(catalog_sorted['gaia_rrl']==0))[0]
#    keep=np.where((catalog_sorted['vlos_raw']==catalog_sorted['vlos_raw'])&(catalog_sorted['vlos_raw_error']<5.)&(catalog_sorted['filtername']=='LoRes')&(catalog_sorted['sn_ratio']>0.)&(gaiaid>0.))[0]
    ...
    keep=np.where((wav_rms>np.percentile(wav_rms,0.1))&(wav_rms<np.percentile(wav_rms,99.9)))[0]
    string='\\newcommand{\mtwofsmedreswavrmsn}{$'+str(len(wav_rms))+'$} \n'
    g0.write(string)
    string='\\newcommand{\mtwofsmedreswavrmsmean}{$'+str(round(np.mean(wav_rms[keep]),3))+'$} \n'
    g0.write(string)
    string='\\newcommand{\mtwofsmedreswavrmsstd}{$'+str(round(np.std(wav_rms[keep]),3))+'$} \n'
    g0.write(string)
    ...
    string='\\newcommand{\mtwofsmedresnrepeatv}{'+str(len(repeat_ind1))+'} \n'
    g0.write(string)
    
    thing_newcommand1=['mtwofsmedressigvfloor','mtwofsmedresteffsigvfloor','mtwofsmedressigtefffloor','mtwofsmedresteffsigtefffloor','mtwofsmedressigloggfloor','mtwofsmedresteffsigloggfloor','mtwofsmedressigfehfloor','mtwofsmedresteffsigfehfloor','mtwofsmedressigmgfefloor','mtwofsmedresteffsigmgfefloor','mtwofsmedressigresolutionfloor','mtwofsmedresteffsigresolutionfloor']
    thing_newcommand2=['mtwofsmedressigvscale','mtwofsmedresteffsigvscale','mtwofsmedressigteffscale','mtwofsmedresteffsigteffscale','mtwofsmedressigloggscale','mtwofsmedresteffsigloggscale','mtwofsmedressigfehscale','mtwofsmedresteffsigfehscale','mtwofsmedressigmgfescale','mtwofsmedresteffsigmgfescale','mtwofsmedressigresolutionscale','mtwofsmedresteffsigresolutionscale']
    thing_newcommand3=['mtwofsmedressigvmixfrac','mtwofsmedresteffsigvmixfrac','mtwofsmedressigteffmixfrac','mtwofsmedresteffsigteffmixfrac','mtwofsmedressigloggmixfrac','mtwofsmedresteffsigloggmixfrac','mtwofsmedressigfehmixfrac','mtwofsmedresteffsigfehmixfrac','mtwofsmedressigmgfemixfrac','mtwofsmedresteffsigmgfemixfrac','mtwofsmedressigresolutionmixfrac','mtwofsmedresteffsigresolutionmixfrac']
    thing_newcommand4=['mtwofsmedressigvsigout','mtwofsmedresteffsigvsigout','mtwofsmedressigteffsigout','mtwofsmedresteffsigteffsigout','mtwofsmedressigloggsigout','mtwofsmedresteffsigloggsigout','mtwofsmedressigfehsigout','mtwofsmedresteffsigfehsigout','mtwofsmedressigmgfesigout','mtwofsmedresteffsigmgfesigout','mtwofsmedressigresolutionsigout','mtwofsmedresteffsigresolutionsigout']
    thing_newcommand5=['mtwofsmedresvnpairs','mtwofsmedresteffvnpairs','mtwofsmedresteffnpairs','mtwofsmedresteffteffnpairs','mtwofsmedresloggnpairs','mtwofsmedresteffloggnpairs','mtwofsmedresfehnpairs','mtwofsmedrestefffehnpairs','mtwofsmedresmgfenpairs','mtwofsmedresteffmgfenpairs','mtwofsmedresresolutionnpairs','mtwofsmedresteffresolutionnpairs']
...
#    m2fs_ratiomax=0.3*10.**(1.8*(1./catalog['sn_ratio'])**0.434)+0.8
...
#    col35=fits.Column(name='rrl',format='I',array=rrl)
    ...
    raw_cols=catalog.columns[0:117]
...
#                        stat=m2fs['vlos_mean_scatter'][this][keep]
                    ...
                    rate.append(rate0)
                    if rate0>0.15:
                        print(i,count,m2fs['fits_filename'][i],m2fs['nthar'][i],m2fs['tempchange'][i],rate0)
    rate=np.array(rate)
