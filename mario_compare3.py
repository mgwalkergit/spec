...
ax1.scatter(z1,z2[this],color='k',s=1)
ax1.errorbar(z1,z2[this],xerr=sigz1,yerr=sigz2[this],fmt='.',capsize=0,mew=0.1,color='k',lw=0.3)
ax1.plot([-1000,1000],[-1000,1000],lw=1,linestyle=':',color='k')
ax1.set_xlim([-4,1])
ax1.set_ylim([-4,1])
ax1.set_xlabel('[Fe/H] from mattraf',fontsize=8)
ax1.set_ylabel('[Fe/H] from marioraf',fontsize=8)

ax2.scatter(sigz1,sigz2[this],color='k',s=1)
ax2.plot([-1000,1000],[-1000,1000],lw=1,linestyle=':',color='k')
ax2.set_xlim([0,2])
ax2.set_ylim([0,2])
ax2.set_xlabel('[Fe/H] error from mattraf',fontsize=8)
ax2.set_ylabel('[Fe/H] error from marioraf',fontsize=8)

plt.savefig('mario_compare3.pdf',dpi=200)
plt.show()
plt.close()
