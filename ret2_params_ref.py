...
refnonmem=np.where( (pmem > 0.9) & (id != 23) & (id != 115) & (id != 126) & (id != 129) & (id != 136) & (id != 138))

keep=np.where((sigv < 5.) & (skewv >= -1.) & (skewv <= 1.) & (kurtv >= -1) & (kurtv <= 1) & (id != 23) & (id != 115) & (id != 126) & (id != 129) & (id != 136) & (id != 138))
mem=np.where((sigv < 5.) & (skewv > -1.) & (skewv < 1.) & (kurtv > -1.1) & (kurtv < 1.1) & (pmem > 0.9) & (id != 23) & (id != 115) & (id != 126) & (id != 129) & (id != 136) & (id != 138))
mem2=np.where((sigv < 5.) & (skewv > -1.) & (skewv < 1.) & (kurtv > -1.1) & (kurtv < 1.1) & (pmem > 0.5) & (pmem < 0.8) & (id != 23) & (id != 115) & (id != 126) & (id != 129) & (id != 136) & (id != 138))
...
#ax6_0.errorbar(v[refnonmem],teff[refnonmem],xerr=sigv[refnonmem],yerr=sigteff[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax5_0.errorbar(v[refnonmem],logg[refnonmem],xerr=sigv[refnonmem],yerr=siglogg[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax4_0.errorbar(v[refnonmem],feh[refnonmem],xerr=sigv[refnonmem],yerr=sigfeh[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax3_0.errorbar(v[refnonmem],r[refnonmem],xerr=sigv[refnonmem],yerr=sigr[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax5_1.errorbar(teff[refnonmem],logg[refnonmem],xerr=sigteff[refnonmem],yerr=siglogg[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax4_1.errorbar(teff[refnonmem],feh[refnonmem],xerr=sigteff[refnonmem],yerr=sigfeh[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax3_1.errorbar(teff[refnonmem],r[refnonmem],xerr=sigteff[refnonmem],yerr=sigr[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax4_2.errorbar(logg[refnonmem],feh[refnonmem],xerr=siglogg[refnonmem],yerr=sigfeh[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax3_3.errorbar(feh[refnonmem],r[refnonmem],xerr=sigfeh[refnonmem],yerr=sigr[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax1_0.errorbar(v[refnonmem],mag[refnonmem],xerr=sigv[refnonmem],yerr=sigmag[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax1_1.errorbar(teff[refnonmem],mag[refnonmem],xerr=sigteff[refnonmem],yerr=sigmag[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax2_3.errorbar(feh[refnonmem],col[refnonmem],xerr=sigfeh[refnonmem],yerr=sigcol[refnonmem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
#ax4_4.set_xlabel(tefflabele[0],fontsize=8,rotation=0)
...
plotfilename='ret2_params_ref.pdf'
