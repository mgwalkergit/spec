...
vlabelx1=[r'$v_{\rm los,1}$ [km/s]']
vlabely1=[r'$v_{\rm los,2}$ [km/s]']
tefflabelx1=[r'$T_{\rm eff,1}$ [$10^3 \mathrm{K}$]']
tefflabely1=[r'$T_{\rm eff,2}$ [$10^3 \mathrm{K}$]']
logglabelx1=[r'$\log_{10}[g/(\mathrm{cm/s}^2)]_{\rm 1}$']
logglabely1=[r'$\log_{10}[g/(\mathrm{cm/s}^2)]_{\rm 2}$']
fehlabelx1=[r'$[\mathrm{Fe/H}]_{\rm 1}$']
fehlabely1=[r'$[\mathrm{Fe/H}]_{\rm 2}$']

ax0_0.set_xlabel(vlabelx1[0],fontsize=8,rotation=0)
ax0_0.set_ylabel(vlabely1[0],fontsize=8,rotation=90,labelpad=5)
ax0_0.set_xlim([-50,250])
ax0_0.set_ylim([-13,13])
ax0_0.set_xscale(u'linear')
ax0_0.set_yscale(u'linear')
#ax0_0.set_xticks([0,100,200,300])
#ax0_0.set_yticks([0,100,200,300])
ax0_0.set_xticks([0,100,200])
ax0_0.set_yticks([-5,0,5])
ax0_0.plot([-1000,1000],[0,0],linestyle=':',color='k',linewidth=0.25)
ax0_0.errorbar(v1,v2-v1,xerr=sigv1,yerr=np.sqrt(sigv2**2+sigv1**2),elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
...
ax0_3.set_xticks([-3,-1,1])
ax0_3.set_yticks([-3,-1,1])
...
#ax1_0.hist(fake,bins=12,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_0.plot(x,mlab.normpdf(x,mean,sigma)*float(len(vdiff))*0.67,color='0.15',linewidth=0.65,zorder=0,linestyle='-',alpha=0.5)
#ax1_0.hist(vdiff,bins=12,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)

ax1_1.set_xlabel(r'$\frac{T_{\rm eff}-\langle T_{\rm eff}\rangle}{\sigma_{T_{\rm eff}}}$')
ax1_1.set_xlim([-5,5])
ax1_1.set_ylim([0,5])
ax1_1.set_yticks([0,1,2,3,4,5])
#ax1_1.set_ylim([0,10])
...
#ax1_1.hist(fake,bins=12,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_1.hist(teffdiff,bins=12,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)

ax1_2.set_xlabel(r'$\frac{\log g-\langle \log g\rangle}{\sigma_{\log g}}$')
ax1_2.set_xlim([-5,5])
#ax1_2.set_ylim([0,10])
ax1_2.set_ylim([0,5])
ax1_2.set_yticks([0,1,2,3,4,5])
...
#ax1_2.hist(fake,bins=12,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
#ax1_2.hist(loggdiff,bins=12,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)

ax1_3.set_xlabel(r'$\frac{[\mathrm{Fe/H}]-\langle [\mathrm{Fe/H}]\rangle}{\sigma_{[\mathrm{Fe/H}]}}$')
ax1_3.set_xlim([-5,5])
#ax1_3.set_ylim([0,10])
ax1_3.set_ylim([0,5])
ax1_3.set_yticks([0,1,2,3,4,5])
...
#ax1_3.hist(fake,bins=12,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_3.hist(fehdiff,bins=12,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)



plotfilename='cra_repeats2.pdf'
