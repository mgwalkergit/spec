...
m2fsrun0=['feb14','dec14','feb15','jul15','sep15','nov15','feb16','jun16','aug16','nov16','feb17','may17','sep17','nov17','feb18','may18','aug18','nov18','feb19','may19','aug19','nov19','jan20','may22','nov22']
#m2fsrun0=['aug16']
...
for i in range(0,len(m2fsrun0)):
    ...
    zero_slurm_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_zero_'+m2fsrun0[i]+'.slurm'
    dark_slurm_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_dark.slurm'#only one master dark for all runs
    reduce_slurm_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_reduce_'+m2fsrun0[i]+'.slurm'
    apertures_slurm_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_apertures_'+m2fsrun0[i]+'.slurm'
    apertures_slurm_noflat_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_apertures_noflat_'+m2fsrun0[i]+'.slurm'
...
#    g1.write('#SBATCH -N 1 \n')
    ...
    g1.write('#SBATCH --cpus-per-task=1 \n')
    g1.write('#SBATCH --time=0-23:59 \n')
    g1.write('#SBATCH --mem=100000 \n')
    g1.write('#SBATCH -o m2fs_zero_'+m2fsrun0[i]+'.o \n')
    g1.write('#SBATCH -e m2fs_zero_'+m2fsrun0[i]+'.err \n')
    g1.write(' \n')
    g1.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/'+zero_out+' \n')
    g1.close()
...
#    g1.write('#SBATCH -N 1 \n')
    ...
    g1.write(' \n')
    g1.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/'+dark_out+' \n')
    g1.close()
...
#    g1.write('#SBATCH -N 1 \n')
    ...
    g1.write(' \n')
    g1.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/'+reduce_out+' \n')
    g1.close()
...
#    g1.write('#SBATCH -N 1 \n')
    ...
    g1.write(' \n')
    g1.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/'+apertures_out+' \n')
    g1.close()
...
#    g1.write('#SBATCH -N 1 \n')
    ...
    g1.write(' \n')
    g1.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/'+apertures_noflat_out+' \n')
    g1.close()
    ...
    for j in range(0,len(utdate)):
        ...
        apertures2_slurm_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_apertures_'+m2fsrun0[i]+'_'+str(j+1)+'.slurm'
        apertures_noflat2_out='m2fs_apertures_noflat_'+m2fsrun0[i]+'_'+str(j+1)+'.py'
        apertures_noflat2_slurm_out='/hildafs/projects/phy200028p/mgwalker/scripts/m2fs_apertures_noflat_'+m2fsrun0[i]+'_'+str(j+1)+'.slurm'
...
#        g3.write('#SBATCH -N 1 \n')
        ...
        g3.write('#SBATCH --cpus-per-task=1 \n')
        g3.write('#SBATCH --time=0-23:59 \n')
        ...
        g3.write(' \n')
        g3.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/m2fs_apertures_'+m2fsrun0[i]+'_'+str(j+1)+'.py \n')
        g3.close()
...
#        g5.write('#SBATCH -N 1 \n')
        ...
        g5.write('#SBATCH --cpus-per-task=1 \n')
        g5.write('#SBATCH --time=0-23:59 \n')
        ...
        g5.write(' \n')
        g5.write('python /hildafs/projects/phy200028p/mgwalker/m2fs/m2fs_apertures_noflat_'+m2fsrun0[i]+'_'+str(j+1)+'.py \n')
        g5.close()
