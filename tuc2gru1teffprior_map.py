...
tuc2_data3='tuc2teffprior.dat'
tuc2_data4='tuc2_ellipsehalf.res'
tuc2_data41='tuc2_ellipsehalf1.res'
tuc2_data42='tuc2_ellipsehalf2.res'
...
with open(tuc2_data41) as g: # read data file
    data=g.readlines()
...
for line in data: # fill arrays
    p=line.split()
    tuc2_ellipse1_x.append(float(p[0]))
    tuc2_ellipse1_y.append(float(p[1]))

tuc2_ellipse1_x=np.array(tuc2_ellipse1_x)
tuc2_ellipse1_y=np.array(tuc2_ellipse1_y)

with open(tuc2_data42) as g: # read data file
    data=g.readlines()
...
for line in data: # fill arrays
    p=line.split()
    tuc2_ellipse2_x.append(float(p[0]))
    tuc2_ellipse2_y.append(float(p[1]))

tuc2_ellipse2_x=np.array(tuc2_ellipse2_x)
tuc2_ellipse2_y=np.array(tuc2_ellipse2_y)
...
gru1_data3='gru1teffprior.dat'
gru1_data4='gru1_ellipsehalf.res'
gru1_data41='gru1_ellipsehalf1.res'
gru1_data42='gru1_ellipsehalf2.res'
...
with open(gru1_data41) as g: # read data file
    data=g.readlines()
...
for line in data: # fill arrays
    p=line.split()
    gru1_ellipse1_x.append(float(p[0]))
    gru1_ellipse1_y.append(float(p[1]))

gru1_ellipse1_x=np.array(gru1_ellipse1_x)
gru1_ellipse1_y=np.array(gru1_ellipse1_y)

with open(gru1_data42) as g: # read data file
    data=g.readlines()
...
for line in data: # fill arrays
    p=line.split()
    gru1_ellipse2_x.append(float(p[0]))
    gru1_ellipse2_y.append(float(p[1]))

gru1_ellipse2_x=np.array(gru1_ellipse2_x)
gru1_ellipse2_y=np.array(gru1_ellipse2_y)
...
ax0_0.set_xlabel(r'$\xi$ [arcmin]',fontsize=12,rotation=0,labelpad=5)
ax0_0.set_ylabel(r'$\eta$ [arcmin]',fontsize=12,rotation=90,labelpad=1)
ax0_0.set_xlim([20,-19.9])
ax0_0.set_ylim([-20,20])
...
ax0_0.set_xticks([20,15,10,5,0,-5,-10,-15])
...
ax0_0.plot(tuc2_ellipse_x,tuc2_ellipse_y,color='k',linewidth=1,ls='-')
#ax0_0.plot(tuc2_ellipse1_x,tuc2_ellipse1_y,color='k',linewidth=1,ls=':')
#ax0_0.plot(tuc2_ellipse2_x,tuc2_ellipse2_y,color='k',linewidth=1,ls=':')
ax0_0.scatter(tuc2_v_xi[tuc2_v_cands],tuc2_v_eta[tuc2_v_cands],s=2,lw=0,edgecolor='none',alpha=0.99,marker='o',color='0.5',rasterized=True)
ax0_0.scatter(tuc2_xi[tuc2_bad],tuc2_eta[tuc2_bad],s=10,lw=1,edgecolor='k',alpha=0.99,marker='x',color='k',rasterized=True)
ax0_0.scatter(tuc2_xi[tuc2_nonmem],tuc2_eta[tuc2_nonmem],s=15,lw=1,edgecolor='k',alpha=0.99,marker='o',facecolor='none',rasterized=True)
ax0_0.scatter(tuc2_xi[tuc2_goodnonmem],tuc2_eta[tuc2_goodnonmem],s=15,lw=1,edgecolor='k',alpha=0.99,marker='o',color='k',rasterized=True)
ax0_0.scatter(tuc2_xi[tuc2_mem],tuc2_eta[tuc2_mem],s=15,lw=1,edgecolor='r',alpha=0.99,marker='o',facecolor='none',rasterized=True)
ax0_0.scatter(tuc2_xi[tuc2_goodmem],tuc2_eta[tuc2_goodmem],s=15,lw=1,edgecolor='r',alpha=0.99,marker='o',color='r',rasterized=True)

ax0_0.arrow(-17,-17,5,0,head_width=1,head_length=1.5,fc='k',ec='k',linewidth=0.5)
ax0_0.arrow(-17,-17,0,5,head_width=1,head_length=1.5,fc='k',ec='k',linewidth=0.5)
ax0_0.text(-10,-15.25,'E',color='k')
ax0_0.text(-16,-9.5,'N',color='k')
ax0_0.text(18,16,'Tuc 2',fontsize=12)

ax0_1.yaxis.set_major_formatter(plt.NullFormatter())
ax0_1.set_xlabel(r'$\xi$ [arcmin]',fontsize=12,rotation=0,labelpad=5)
#ax0_1.set_ylabel(r'$\eta$ [arcmin]',fontsize=8,rotation=90,labelpad=1)
ax0_1.set_xlim([19.9,-20])
ax0_1.set_ylim([-20,20])
ax0_1.set_xscale(u'linear')
ax0_1.set_yscale(u'linear')
ax0_1.set_yticks([-20,-15,-10,-5,0,5,10,15,20])
#ax0_0.set_xticklabels(vticks,rotation=0)
ax0_1.set_yticklabels([])
ax0_1.set_xticks([15,10,5,0,-5,-10,-15])
#ax0_0.set_yticklabels([4000]+teffticks,rotation=0)
#ax0_0.errorbar(v[gru1_keep],teff[gru1_keep],xerr=sigv[gru1_keep],yerr=sigteff[gru1_keep],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
circle1=plt.Circle((0.,2),14.75,color='0.25',alpha=0.35)
ax0_1.add_artist(circle1)

ax0_1.plot(gru1_ellipse_x,gru1_ellipse_y,color='k',linewidth=1,ls='-')
#ax0_1.plot(gru1_ellipse1_x,gru1_ellipse1_y,color='k',linewidth=1,ls=':')
#ax0_1.plot(gru1_ellipse2_x,gru1_ellipse2_y,color='k',linewidth=1,ls=':')
ax0_1.scatter(gru1_v_xi[gru1_v_cands],gru1_v_eta[gru1_v_cands],s=2,lw=0,edgecolor='none',alpha=0.99,marker='o',color='0.5',rasterized=True)
ax0_1.scatter(gru1_xi[gru1_bad],gru1_eta[gru1_bad],s=10,lw=1,edgecolor='k',alpha=0.99,marker='x',color='k',rasterized=True)
ax0_1.scatter(gru1_xi[gru1_nonmem],gru1_eta[gru1_nonmem],s=15,lw=1,edgecolor='k',alpha=0.99,marker='o',facecolor='none',rasterized=True)
ax0_1.scatter(gru1_xi[gru1_goodnonmem],gru1_eta[gru1_goodnonmem],s=15,lw=1,edgecolor='k',alpha=0.99,marker='o',color='k',rasterized=True)
ax0_1.scatter(gru1_xi[gru1_mem],gru1_eta[gru1_mem],s=15,lw=1,edgecolor='r',alpha=0.99,marker='o',facecolor='none',rasterized=True)
ax0_1.scatter(gru1_xi[gru1_goodmem],gru1_eta[gru1_goodmem],s=15,lw=1,edgecolor='r',alpha=0.99,marker='o',color='r',rasterized=True)
...
ax0_1.text(18,16,'Gru 1',fontsize=12)


plotfilename='tuc2gru1teffprior_map.pdf'
