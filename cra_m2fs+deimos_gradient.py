...
data1='cra_gradientpost_equal_weights.dat'
data2='cram2fs+deimos_gradientpost_equal_weights.dat'

out1='cra_m2fs+deimos_gradientcommands.tex'
out2='cra_m2fs+deimos_gradient_table.tex'
g1=open(out1,'w')
g2=open(out2,'w')
...
statsvmean=np.percentile(vmean2,[2.5,16.,50.,84.,97.5])
statsvdisp=np.percentile(vdisp2,[2.5,16.,50.,84.,97.5])
statsvgrad=np.percentile(vgrad2,[2.5,16.,50.,84.,97.5])
statsvtheta=np.percentile(vtheta2,[2.5,16.,50.,84.,97.5])
statsfehdisp=np.percentile(fehdisp2,[2.5,16.,50.,84.,97.5])
statsfehmean=np.percentile(fehmean2,[2.5,16.,50.,84.,97.5])
statsfehgrad=np.percentile(fehgrad2,[2.5,16.,50.,84.,97.5])
...
vmeanticks=[140,145,150,155,160]
vdispticks=[0,1,2,3,4,5]
...
ax0_0.hist(vmean2,bins=50,range=vmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5)
...
ax0_1.hist(vdisp2,bins=50,range=vdisplim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5)
...
ax0_2.hist(vgrad2,bins=50,range=vgradlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5)
...
ax0_3.hist(vtheta2,bins=50,range=vthetalim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5)
...
ax0_4.hist(fehmean2,bins=50,range=fehmeanlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5)
...
ax0_5.hist(fehdisp2,bins=50,range=fehdisplim,normed=True,histtype='step',align='mid',rwidth=0,orientation='vertical',color='r',linewidth=0.5)
...
ax1_6.hist(fehgrad2,bins=50,range=fehgradlim,normed=True,histtype='step',align='mid',rwidth=0,orientation='horizontal',color='r',linewidth=0.5)
...
g1.close()
g2.close()
plotfilename='cra_m2fs+deimos_gradient.pdf'
