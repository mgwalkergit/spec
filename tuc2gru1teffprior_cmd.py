...
tuc2_hires=np.where(tuc2_resolution == 'hires')
tuc2_medres=np.where(tuc2_resolution == 'medres')
...
gru1_hires=np.where(gru1_resolution == 'hires')
gru1_medres=np.where(gru1_resolution == 'medres')
...
#ax0_0.scatter(tuc2_gmag[tuc2_hires]-tuc2_rmag[tuc2_hires],tuc2_rmag[tuc2_hires],s=15,lw=1,edgecolor='r',alpha=0.99,marker='o',color='g',rasterized=True)

tuc2_maglimx=np.array([-10,0.25,0.55,10])
tuc2_maglimy=np.array([20,20,19.4,19.4])

ax0_0.plot(tuc2_maglimx,tuc2_maglimy,lw=1,color='k',linestyle='--',rasterized=True)
...
#ax0_1.scatter(gru1_gmag[gru1_hires]-gru1_rmag[gru1_hires],gru1_rmag[gru1_hires],s=15,lw=1,edgecolor='r',alpha=0.99,marker='o',color='g',rasterized=True)

gru1_maglimx=np.array([-10,-0.1,0.277,0.372,0.435,0.456,0.563,0.607,10])
gru1_maglimy=np.array([21.5,21.5,20.87,20.82,20.82,20.65,20.65,20.6,20.5])

ax0_1.plot(gru1_maglimx,gru1_maglimy,lw=1,color='k',linestyle='--',rasterized=True)
...
plotfilename='tuc2gru1teffprior_cmd.pdf'
