...
tuc2_data1='tuc2teffprior_gradientpost_equal_weights.dat'
gru1_data1='gru1teffprior_gradientpost_equal_weights.dat'
out1='tuc2gru1teffprior_grfcommands.tex'
g1=open(out1,'w')
...
tuc2_distance=Distance(120,u.kpc)

tuc2_coords=SkyCoord(tuc2_racenter,tuc2_deccenter,distance=tuc2_distance,unit=['deg','deg'])
