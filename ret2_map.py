...
dmodulus=17.4
data1='ret2_vasilyphot.dat'
data2='age12fehm250.iso'
#data2='parsec.dat'
data3='ret2.dat'
data4='ret2_ellipsecore.res'
...
v_radegcenter=53.9256
v_decdegcenter=-54.0492
...
mem1=np.where((sigv < 10.) & (skewv > -1.) & (skewv < 1.) & (kurtv > -1.1) & (kurtv < 1.1) & (pmem > 0.9))
...
center=np.where((v_r < 15.) & (v_spreadg < 0.003) & (v_spreadr < 0.003))
...
ax0_0.text(-0.4,16.5,'Ret 2',fontsize=10)
...
#ax0_0.set_yticklabels([4000]+teffticks,rotation=0)
#ax0_0.errorbar(v[keep],teff[keep],xerr=sigv[keep],yerr=sigteff[keep],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='k',rasterized=True)
circle1=plt.Circle((-4.2,-1.1),14.75,color='0.25',alpha=0.35)
