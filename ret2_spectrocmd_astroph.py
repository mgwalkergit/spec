...
for line in data: # fill arrays
    p=line.split()
    gmag.append(float(p[0]))
    rmag.append(float(p[1]))
    v.append(float(p[3]))
    sigv.append(float(p[4]))
    skewv.append(float(p[5]))
    kurtv.append(float(p[6]))
    teff.append(float(p[7]))
    sigteff.append(float(p[8]))
    skewteff.append(float(p[9]))
    kurtteff.append(float(p[10]))
    logg.append(float(p[11]))
    siglogg.append(float(p[12]))
    skewlogg.append(float(p[13]))
    kurtlogg.append(float(p[14]))
    feh.append(float(p[15]))
    sigfeh.append(float(p[16]))
    skewfeh.append(float(p[17]))
    kurtfeh.append(float(p[18]))
    pmem.append(float(p[19]))
...
for line in iso_data: # fill arrays
    p=line.split()
    iso125_teff.append(float(p[2]))
    iso125_logg.append(float(p[3]))
    iso125_g.append(float(p[6]))
    iso125_r.append(float(p[7]))
    iso125_i.append(float(p[8]))

iso125_g=np.array(iso125_g)
iso125_r=np.array(iso125_r)
iso125_i=np.array(iso125_i)
iso125_logg=np.array(iso125_logg)
iso125_teff=np.array(iso125_teff)
iso125_teff=10.**iso125_teff
...
ax1_0.plot(iso125_teff,iso125_logg,lw=1,color='r')
...
ax0_0.plot(iso125_teff,iso125_r+dmodulus,lw=1,color='r',label=r"[Fe/H]=$-1.25$")
...
ax1_1.plot(iso125_r+dmodulus,iso125_logg,lw=1,color='r',label=r"[Fe/H]=$-1.25$")
...
plotfilename='ret2_spectrocmd_astroph.pdf'
