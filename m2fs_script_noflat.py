...
m2fsrun0=['feb14','dec14','feb15','jul15','sep15','feb16','jun16','aug16','nov16','feb17','may17','sep17','nov17','feb18','may18','aug18','nov18','feb19','may19','aug19','nov19','jan20']
#m2fsrun0=['aug16']
...
#    g1.write('#SBATCH --partition=short \n')
    ...
    for j in range(0,len(utdate)):
        ...
        g1.write(utdate[j]+' '+str(file1[j]).zfill(4)+' '+str(file2[j]).zfill(4)+' '+flatfile[j]+' '+tharfile[j]+' '+field_name[j]+' '+scifile[j]+' '+fibermap_file[j]+' '+fiber_changes[j]+' \n')
        g1.close()
