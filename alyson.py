...
data1='h258.grp29.dat'
data2='h258.grp16.dat'
...
for line in data: # fill arrays
    ...
    y1.append(float(p[1]))
    z1.append(float(p[2]))
    vx1.append(float(p[3]))
    vy1.append(float(p[4]))
    vz1.append(float(p[5]))
    age1.append(float(p[6]))
    mass1.append(float(p[7]))
    feh1.append(float(p[8]))
    oh1.append(float(p[9]))
...
for line in data: # fill arrays
    ...
    y2.append(float(p[1]))
    z2.append(float(p[2]))
    vx2.append(float(p[3]))
    vy2.append(float(p[4]))
    vz2.append(float(p[5]))
    age2.append(float(p[6]))
    mass2.append(float(p[7]))
    feh2.append(float(p[8]))
    oh2.append(float(p[9]))
...
statsvmean2=np.percentile(vmean2,[2.5,16.,50.,84.,97.5])
statsvdisp2=np.percentile(vdisp2,[2.5,16.,50.,84.,97.5])
statsvgrad2=np.percentile(vgrad2,[2.5,16.,50.,84.,97.5])
statsvtheta2=np.percentile(vtheta2,[2.5,16.,50.,84.,97.5])
statsfehdisp2=np.percentile(fehdisp2,[2.5,16.,50.,84.,97.5])
statsfehmean2=np.percentile(fehmean2,[2.5,16.,50.,84.,97.5])
statsfehgrad2=np.percentile(fehgrad2,[2.5,16.,50.,84.,97.5])
...
g1.close()
g2.close()
plotfilename='ret2_gradient.pdf'
