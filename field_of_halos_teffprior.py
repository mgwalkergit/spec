...
#                    sspp_m2fsmedres_compare_alpha.append((sspp_alpha[i],sspp_sigalpha[i],m2fsmedres_alpha[this[j]],m2fsmedres_sigalpha[this[j]],6,5))
    ...
    pickle.dump((x1,sigx1,x2,sigx2,survey1,survey2),open('crap_teffprior_vlos.pkl','wb'))
    offset=offset_v
    dmax=dmax_v
    ...
    pickle.dump((x1,sigx1,x2,sigx2,survey1,survey2),open('crap_teffprior_teff.pkl','wb'))
    offset=offset_teff
    dmax=dmax_teff
    keep=np.where((survey1!=7)&(survey2!=7)&(survey1!=8)&(survey2!=8))[0]
    ...
    pickle.dump((x1,sigx1,x2,sigx2,survey1,survey2),open('crap_teffprior_logg.pkl','wb'))
    offset=offset_logg
    dmax=dmax_logg
    keep=np.where((survey1!=7)&(survey2!=7)&(survey1!=8)&(survey2!=8))[0]
    ...
    pickle.dump((x1,sigx1,x2,sigx2,survey1,survey2),open('crap_teffprior_z.pkl','wb'))
    offset=offset_z
    dmax=dmax_z
    keep=np.where((survey1!=7)&(survey2!=7)&(survey1!=8)&(survey2!=8))[0]
    ...
    pickle.dump((x1,sigx1,x2,sigx2,survey1,survey2),open('crap_teffprior_alpha.pkl','wb'))
    offset=offset_alpha
    dmax=dmax_alpha
    keep=np.where((survey1!=7)&(survey2!=7)&(survey1!=8)&(survey2!=8))[0]
...
#    ax24.errorbar(kirby_m2fsmedres_compare_alpha.T[2][m2fsmedres_keep],kirby_m2fsmedres_compare_alpha.T[0][m2fsmedres_keep],xerr=kirby_m2fsmedres_compare_alpha.T[3][m2fsmedres_keep],yerr=kirby_m2fsmedres_compare_alpha.T[1][m2fsmedres_keep],alpha=0.3,fmt='.',elinewidth=0.5,color='cyan',label='M2FS',ms=1,rasterized=True)
    ...
    plt.savefig('teffprior_atm_offset_dev.pdf',dpi=270)
    plt.show()
    plt.close()        
