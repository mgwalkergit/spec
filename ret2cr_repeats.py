...
data1='ret2cr_subexposures.dat'
data2='ret2cr_subexposures2.dat'
data3='ret2cr_subexposures3.dat'
...
ax0_0.set_xlim([0,300])
ax0_0.set_ylim([0,300])
...
ax1_0.set_ylabel('N',rotation=0,labelpad=10)
ax1_0.set_xlim([-5,5])
#ax1_0.set_ylim([0,10])
...
ax1_0.hist(fakediff,bins=25,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_0.hist(vdiff,bins=25,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)
...
ax1_1.hist(fakediff,bins=25,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_1.hist(teffdiff,bins=25,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)
...
ax1_2.hist(fakediff,bins=25,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_2.hist(loggdiff,bins=25,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)
...
ax1_3.hist(fakediff,bins=25,range=[-5,5],normed=False,histtype='stepfilled',align='mid',rwidth=0,orientation='vertical',color='0.5',linewidth=0,alpha=0.5)
ax1_3.hist(fehdiff,bins=25,range=[-5,5],normed=False,histtype='step',align='mid',rwidth=0,orientation='vertical',color='k',linewidth=0.5)



plotfilename='ret2cr_repeats.pdf'
