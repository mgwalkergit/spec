...
ax0_0.plot(iso100_teff,iso100_i+dmodulus,lw=1,color='r',label=r"[Fe/H]=$-1.0$")
...
ax0_0.errorbar(teff[mem],imag[mem],xerr=sigteff[mem],yerr=siglogg[mem]-siglogg[mem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='r',rasterized=True)
ax0_0.legend(loc=[0.05,0.57],fontsize=12,handlelength=0,shadow=False)
#ax0_0.text(-0.4,16.5,'Crater',fontsize=10)
ax0_0.text(7500,16.5,'Grus 1',fontsize=12)

ax1_1.set_xlabel(r'$i$ [mag]',fontsize=12,rotation=0,labelpad=5)
#ax1_1.set_ylabel(r'$\log g$',fontsize=12,rotation=90,labelpad=5)
ax1_1.set_xlim([22.49,15.5])
...
ax1_1.set_xticks([22,21,20,19,18,17,16])
ax1_1.plot(iso250_i+dmodulus,iso250_logg,lw=1,color='b',label=r"[Fe/H]=$-2.5$")
ax1_1.plot(iso100_i+dmodulus,iso100_logg,lw=1,color='r',label=r"[Fe/H]=$-1.0$")
...
ax1_1.errorbar(imag[mem],logg[mem],xerr=sigteff[mem]-sigteff[mem],yerr=siglogg[mem],elinewidth=0.25,fmt='.',capsize=0,alpha=1,color='r',rasterized=True)
...
plotfilename='gru1_phoenix_spectrocmd.pdf'
