...
data1='ret2_gradientpost_equal_weights.dat'
data2='ret2_gradient2post_equal_weights.dat'

out1='ret2_gradientcommands.tex'
out2='ret2_gradient_table.tex'
g1=open(out1,'w')
g2=open(out2,'w')
...
for line in data2: # fill arrays
    ...
    offset2.append(float(p[7]))
    like2.append(float(p[8]))
