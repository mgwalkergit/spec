...
for line in data: # fill arrays
    ...
    r.append(float(p[4]))
    v.append(float(p[5]))
    sigv.append(float(p[6]))
    feh.append(float(p[7]))
    sigfeh.append(float(p[8]))
    pmem.append(float(p[9]))
...
ax0_0.set_xlim([0,2])
ax0_0.set_ylim([22,17])
ax0_0.set_xscale(u'linear')
ax0_0.set_yscale(u'linear')
ax0_0.set_yticks([22,21,20,19,18,17])
...
ax0_0.scatter(v_gmag[center]-v_imag[center],v_imag[center],s=2,lw=0,edgecolor='none',alpha=0.99,marker='o',color='0.5',rasterized=True)
#ax0_0.scatter(v_gmag[v_cands]-v_imag[v_cands],v_imag[v_cands],s=2,lw=0,edgecolor='none',alpha=0.99,marker='o',color='r',rasterized=True)
...
#ax0_0.scatter(gmag[keep]-imag[keep],imag[keep],s=15,lw=0,edgecolor='none',alpha=0.99,marker='o',color='k',rasterized=True)
