...
fits_list0='all_m2fshiresian_files3'
fits_list='/hildafs/projects/phy200028p/mgwalker/m2fs/'+fits_list0
fits_table_filename=fits_list.split('_files')[0]+'.fits'
data_out=fits_list.split('_files3')[0]+'.dat'
data_filename='/hildafs/projects/phy200028p/mgwalker/MultiNest_v2.17/'+fits_list0.split('_files3')[0]+'_data'
chains_filename='/hildafs/projects/phy200028p/mgwalker/MultiNest_v2.17/'+fits_list0.split('_files3')[0]+'_chains'
